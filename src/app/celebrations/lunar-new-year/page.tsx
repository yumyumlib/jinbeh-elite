...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://jinbeh.com/celebrations/lunar-new-year",
  },
};
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Lunar New Year" },
  ],
};
  ...
  return (
    <>
      ...
      <div className="container mx-auto max-w-6xl px-4 lg:px-6">
        <BreadcrumbNav items={[{ label: "Celebrations", href: "/celebrations" }, { label: "Lunar New Year" }]} />
      </div>
...
<section className="relative h-[70vh] min-h-[500px] flex items-center justify-center overflow-hidden">
          ...
          <Image
            src="/images/food/HappyNewYear.jpg"
            alt="Lunar New Year Dinner Frisco at Jinbeh Japanese restaurant"
            fill
        ...
        <section className="py-16 bg-warm-ivory">
          <div className="container mx-auto px-6">
            ...
            <div className="flex flex-wrap justify-center gap-3 max-w-3xl mx-auto text-sm">
              ...
              <Link href="/menu" className="px-4 py-2 bg-white rounded-full text-charcoal hover:bg-accent-red hover:text-white transition-colors">Sashimi</Link>
              <Link href="/frisco/cocktails" className="px-4 py-2 bg-white rounded-full text-charcoal hover:bg-accent-red hover:text-white transition-colors">Premium Sake</Link>
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-6">
            <h2 className="text-2xl font-heading font-bold text-charcoal mb-8 text-center">
              Lunar New Year Dining Inspiration
            </h2>
            <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
              <Link href="/blog/popular-japanese-culture" className="group block bg-warm-ivory rounded-xl p-6 hover:shadow-lg transition-shadow">
                <span className="text-sm text-accent-red font-medium uppercase tracking-wider">Culture</span>
                <h3 className="font-heading text-lg font-semibold text-charcoal mt-2 group-hover:text-accent-red transition-colors">
                  Popular Japanese Culture: Food & Traditions
                </h3>
                <p className="text-sm text-charcoal/70 mt-2">Explore how Japanese traditions celebrate the new year with food and ceremony.</p>
              </Link>
              <Link href="/blog/types-of-sake-explained" className="group block bg-warm-ivory rounded-xl p-6 hover:shadow-lg transition-shadow">
                <span className="text-sm text-accent-red font-medium uppercase tracking-wider">Sake Guide</span>
                <h3 className="font-heading text-lg font-semibold text-charcoal mt-2 group-hover:text-accent-red transition-colors">
                  Types of Sake Explained
                </h3>
                <p className="text-sm text-charcoal/70 mt-2">Ring in the new year with the perfect celebratory sake.</p>
              </Link>
            </div>
          </div>
        </section>
      ...
      <PageSeoBoost route="/celebrations/lunar-new-year" />
      <Footer />
    </>
  );
}
