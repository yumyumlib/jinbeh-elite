...
export const metadata: Metadata = {
  ...
  description: "Best Japanese food and hibachi restaurant in Little Elm, TX. Jinbeh offers authentic Japanese cuisine, teppanyaki shows, and fresh sushi just minutes away in Frisco. Reserve your table today.",
  keywords: [
    "japanese food little elm tx",
    "japanese restaurant little elm texas",
    "hibachi little elm",
    "sushi little elm tx",
    "teppanyaki little elm",
    "best japanese food little elm",
    "authentic japanese cuisine little elm",
  ],
  alternates: {
    canonical: "https://jinbeh.com/nearby/little-elm",
  },
  openGraph: {
    title: "Japanese Food Little Elm TX | Hibachi & Sushi | Jinbeh",
...
const localBusinessSchema = {
  ...
  priceRange: "$$",
  areaServed: ["Little Elm", "Lewisville", "Frisco", "Dallas", "Texas"],
...
// FAQ Schema targeting Little Elm keywords
const faqSchema = {
  "@context": "https://schema.org",
  "@type": "FAQPage",
  mainEntity: [
    {
      "@type": "Question",
      name: "Where can I find Japanese food near Little Elm?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Jinbeh offers authentic Japanese food just minutes from Little Elm. Lewisville location is closest at 7 minutes, with Frisco location also available at 11 minutes. We serve hibachi, sushi, and traditional Japanese cuisine.",
      },
    },
    {
      "@type": "Question",
      name: "How far is Jinbeh from Little Elm?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Jinbeh Lewisville is located just 7 minutes from Little Elm, making it the closest Japanese restaurant for Little Elm residents. Jinbeh Frisco is also available, approximately 11 minutes away.",
      },
    },
    {
      "@type": "Question",
      name: "What Japanese food does Jinbeh serve?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Jinbeh serves authentic Japanese cuisine including hibachi tableside shows, fresh sushi bar with premium rolls, sashimi, nigiri, and traditional Japanese appetizers and main courses. We also offer a full bar with sake and Japanese beverages.",
      },
    },
    {
      "@type": "Question",
    ...
    {
      "@type": "Question",
      name: "Is hibachi good for family dining from Little Elm?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Yes! Hibachi is perfect for families. Kids love watching the chefs perform tricks like the famous onion volcano and see their food cooked tableside. Our family-friendly atmosphere makes it great for celebrations.",
      },
    },
    {
      "@type": "Question",
      name: "Do you offer authentic Japanese cuisine at Jinbeh?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Yes! We specialize in authentic Japanese cuisine prepared by skilled chefs. Family-owned since 1988 with nearly 40 years of tradition, we bring genuine Japanese culinary traditions to Little Elm.",
      },
    },
    {
      "@type": "Question",
      name: "What are the Japanese restaurant hours near Little Elm?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Lunch: Monday-Friday 11am-2pm, Saturday-Sunday 11:30am-2:30pm. Dinner: Sunday-Thursday 5pm-9pm, Friday-Saturday 5pm-10pm. Both Lewisville and Frisco locations serve these hours.",
      },
    },
  ],
};

export default function LittleElmNearbyPage() {
  return (
    <>
      <Header />
      ...
      <main className="min-h-screen">
        ...
        <section className="hero relative bg-charcoal">
          <div
            ...
            style={{
              backgroundImage: "url('/images/lewisville/IMG_1910.jpg')",
            }}
          />
          ...
          <div className="hero-content max-w-4xl mx-auto">
            <h1 className="text-4xl md:text-6xl font-heading font-bold mb-4">
              Little Elm&apos;s Favorite Japanese Restaurant<br />Is Just 7 Minutes Away
            </h1>
            <p className="text-xl text-warm-ivory/90 mb-6">
              Authentic Japanese food at Jinbeh Lewisville
            </p>
            <p className="text-lg text-warm-ivory/80 max-w-2xl mx-auto mb-8">
              Experience authentic Japanese cuisine with hibachi tableside shows and fresh sushi. Jinbeh brings traditional Japanese culinary traditions to Little Elm with skilled chefs and premium ingredients.
            </p>
        ...
        <section className="py-16 bg-accent-red text-white">
          <div className="container mx-auto px-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
              <div>
                <div className="text-5xl font-bold mb-2">7 mins</div>
                <p className="text-lg text-white/90">From Little Elm</p>
              </div>
              <div>
                <div className="text-5xl font-bold mb-2">3.8 miles</div>
        ...
        <section className="py-16 bg-warm-ivory">
          <div className="container mx-auto px-6">
            <h2 className="font-heading text-3xl font-bold text-charcoal text-center mb-12">
              Why Little Elm Residents Choose Jinbeh
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              <div className="card">
                ...
                <p className="text-charcoal/70">
                  Traditional recipes and techniques bring genuine Japanese culinary traditions to your table. Every dish is prepared with care and authentic ingredients.
                </p>
              </div>
              ...
              <div className="card">
                <div className="text-4xl mb-4">🔥</div>
                <h3 className="font-heading text-xl font-semibold text-charcoal mb-3">
                  Hibachi Tableside Shows
                </h3>
                <p className="text-charcoal/70">
                  Watch skilled teppanyaki chefs perform exciting tricks right at your table. The famous onion volcano and knife skills create entertainment and amazing food.
                </p>
              </div>
              ...
              <div className="card">
                ...
                <p className="text-charcoal/70">
                  Kids love watching the hibachi shows, and we have options for all ages. A favorite dining destination for Little Elm families and celebrations.
                </p>
              </div>
              ...
              <div className="card">
                ...
                <p className="text-charcoal/70">
                  Birthdays, anniversaries, and special events become unforgettable at Jinbeh. Our Japanese cuisine and hibachi shows make every celebration memorable.
                </p>
              </div>
            </div>
        </section>
                ...
                <div className="flex items-start gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-accent-red font-semibold">
                      Closest to Little Elm - 7 minutes
                    </p>
                  </div>
                </div>
            ...
            <div className="max-w-3xl mx-auto space-y-4">
              <details className="group border border-charcoal/20 rounded-lg p-6 cursor-pointer hover:border-accent-red transition-colors">
                <summary className="flex items-center justify-between font-semibold text-charcoal">
                  <span>How far is Jinbeh from Little Elm?</span>
                ...
                <p className="text-charcoal/70 mt-4">
                  Jinbeh Lewisville is just 7 minutes from Little Elm (approximately 3.8 miles), making it the closest Japanese restaurant for Little Elm residents. Jinbeh Frisco is an alternative option about 11 minutes away.
                </p>
              </details>

              <details className="group border border-charcoal/20 rounded-lg p-6 cursor-pointer hover:border-accent-red transition-colors">
                <summary className="flex items-center justify-between font-semibold text-charcoal">
                  <span>Do you take reservations from Little Elm?</span>
                  <svg className="w-5 h-5 text-accent-red group-open:rotate-180 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 14l-7 7m0 0l-7-7m7 7V3" />
                  </svg>
                </summary>
              ...
              <details className="group border border-charcoal/20 rounded-lg p-6 cursor-pointer hover:border-accent-red transition-colors">
                <summary className="flex items-center justify-between font-semibold text-charcoal">
                  <span>What makes Jinbeh&apos;s Japanese food authentic?</span>
                  <svg className="w-5 h-5 text-accent-red group-open:rotate-180 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 14l-7 7m0 0l-7-7m7 7V3" />
                  </svg>
                </summary>
              ...
              <details className="group border border-charcoal/20 rounded-lg p-6 cursor-pointer hover:border-accent-red transition-colors">
                <summary className="flex items-center justify-between font-semibold text-charcoal">
                  <span>Do you offer private dining for Japanese food events?</span>
                  <svg className="w-5 h-5 text-accent-red group-open:rotate-180 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 14l-7 7m0 0l-7-7m7 7V3" />
                  </svg>
                </summary>
                <p className="text-charcoal/70 mt-4">
                  Yes! We offer private hibachi dining perfect for team building, family events, and corporate celebrations. Contact us to discuss your event requirements and customize the perfect Japanese dining experience.
                </p>
              </details>
        ...
        <section className="py-16 bg-deep-indigo text-warm-ivory">
          <div className="container mx-auto px-6 text-center">
            <h2 className="font-heading text-3xl font-bold mb-6">
              Ready for Authentic Japanese Food?
            </h2>
            <p className="text-warm-ivory/80 max-w-2xl mx-auto mb-8">
              Just 7 minutes from Little Elm. Reserve your table today and discover why Little Elm residents love Jinbeh for hibachi, sushi, and authentic Japanese dining experiences.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href={lewisvilleLocation.reservation.url}
