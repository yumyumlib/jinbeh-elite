...
export const metadata: Metadata = {
  ...
  description: "Eel roll topped with avocado slices Enjoy Caterpillar Roll at Jinbeh Japanese Restaurant in Frisco, TX. Near Stonebriar Centre, minutes from Legacy West. Call (214) 618-9888 to reserve.",
...
const faqSchema = {
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes! Caterpillar Roll is available for takeout and delivery. For the freshest experience, we recommend dining in at our sushi bar. Call (214) 618-9888 to order."
      }
    },
    {
      "@type": "Question",
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg mb-8">
                ...
                <div className="space-y-6">
                  ...
                  <details className="group border-b border-warm-ivory pb-4">
                    ...
                    <p className="mt-4 text-charcoal/70 leading-relaxed">
                      Yes! Caterpillar Roll is available for takeout and delivery. For the freshest experience, we recommend dining in at our sushi bar. Call (214) 618-9888 to order.
                    </p>
                  </details>
                  <details className="group border-b border-warm-ivory pb-4">
                    <summary className="flex justify-between items-center cursor-pointer list-none">
