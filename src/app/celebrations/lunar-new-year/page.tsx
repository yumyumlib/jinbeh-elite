...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "We recommend making reservations, especially for the Lunar New Year Eve (Feb 16) and New Year's Day (Feb 17). Call Frisco at (214) 618-9888 or Lewisville at (214) 618-9798.",
      },
    },
    {
      "@type": "Question",
