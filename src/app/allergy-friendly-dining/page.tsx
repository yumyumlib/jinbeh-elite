...
export const metadata: Metadata = {
    ...
    description:
        "Jinbeh accommodates gluten-free, dairy-free, nut-free, and shellfish-free dining. Our hibachi chefs cook at your table and adapt to your needs.",
    keywords: [
                    ...
                    <div className="relative z-10 container mx-auto px-6 text-center">
                        ...
                        <div className="flex flex-wrap justify-center gap-6 md:gap-10 mt-12 text-warm-ivory/70 text-sm">
                            <div className="flex items-center gap-2">
                                ...
                                <span>
                                    4.6 Google · Rated 4.7–4.8 Across Platforms Across Platforms
                                </span>
                            </div>
                            <div className="flex items-center gap-2">
                                <span className="text-lg">👨‍👩‍👧‍👦</span>
