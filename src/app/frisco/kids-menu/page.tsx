...
const kidsMenuSchema = {
  ...
  "@type": "Menu",
  "name": "Kids Menu - Jinbeh Frisco",
  "description":
    "Kids menu at Jinbeh Japanese Restaurant in Frisco, featuring hibachi, sushi rolls, and Japanese dishes for children",
  "hasMenuSection": [
    {
      "@type": "MenuSection",
      "name": "Kids Hibachi",
...
export default function KidsMenuFriscoPage() {
  return (
    <>
      <Header />
        ...
        <section className="py-20 bg-gradient-to-br from-accent-red to-deep-indigo text-white">
          <div className="container mx-auto px-6 text-center">
            ...
            <div className="bg-white/20 backdrop-blur rounded-2xl p-8 max-w-3xl mx-auto mb-10">
              <h3 className="font-heading text-2xl font-bold mb-6 text-warm-ivory">Jinbeh Frisco</h3>
