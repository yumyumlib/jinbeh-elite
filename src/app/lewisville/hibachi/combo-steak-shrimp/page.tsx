...
export const metadata: Metadata = {
  ...
  keywords: ["steak shrimp combo hibachi lewisville","surf and turf teppanyaki lewisville tx","best hibachi near me lewisville","filet mignon shrimp combo","high protein hibachi","meat seafood pairing","japanese steakhouse lewisville","best hibachi lewisville tx"],
  openGraph: {
                  ...
                  <tbody className="divide-y divide-warm-ivory">
                    <tr>
                      ...
                      <td className="py-4 text-right">
                        <span className="text-accent-red font-bold">$38.95</span>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg mb-8">
                ...
                <div className="space-y-6">
                  ...
                  <details className="group border-b border-warm-ivory pb-4">
                    ...
                    <p className="mt-4 text-charcoal/70 leading-relaxed">
                      Absolutely! Steak & Shrimp Combo is one of our most popular choices for birthdays, anniversaries, and celebrations. The interactive cooking show makes any meal memorable. Call (972) 221-3888 to reserve for your special event.
                    </p>
                  </details>
                  <details className="group border-b border-warm-ivory pb-4">
                    <summary className="flex justify-between items-center cursor-pointer list-none">
