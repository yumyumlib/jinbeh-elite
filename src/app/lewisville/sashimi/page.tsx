...
export const metadata: Metadata = {
  ...
  description: "Explore Jinbeh Lewisville's sashimi menu. Purity, premium fish, elegant simplicity. 7 delicious options from Salmon Sashimi to Omakase Selection. Easy access from I-35E, near Vista Ridge Mall.",
  ...
  openGraph: {
    ...
    description: "Purity, premium fish, elegant simplicity. 7 sashimi options at Jinbeh Lewisville.",
    url: "https://jinbeh.com/lewisville/sashimi",
  },
  alternates: {
    canonical: "https://jinbeh.com/lewisville/sashimi",
  },
};
...
const menuSchema = {
  ...
  "@type": "Menu",
  "name": "Sashimi Menu - Jinbeh Lewisville",
  "description": "Sashimi menu at Jinbeh Japanese Restaurant in Lewisville, TX",
  "hasMenuSection": {
    "@type": "MenuSection",
    "name": "Sashimi",
    "hasMenuItem": [
...
const faqSchema = {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What sashimi does Jinbeh Lewisville serve?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Jinbeh Lewisville offers an extensive sashimi menu with 7 options including favorites like Salmon Sashimi, Tuna Sashimi, Yellowtail Sashimi, and more. All prepared fresh by our skilled chefs."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Guest favorites include Salmon Sashimi ($14.95), Tuna Sashimi ($16.95), Yellowtail Sashimi ($15.95), Octopus Sashimi ($14.95). These are consistently rated as the best sashimi in Lewisville."
      }
    },
    {
      "@type": "Question",
    ...
    {
      "@type": "Question",
      "name": "What are sashimi prices at Jinbeh Lewisville?",
      "acceptedAnswer": {
        "@type": "Answer",
...
export default function SashimiLewisvillePage() {
  return (
    <>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg space-y-6">
                <details className="group border-b border-warm-ivory pb-4">
                  <summary className="flex justify-between items-center cursor-pointer list-none">
                    <h3 className="font-medium text-charcoal pr-4">What sashimi does Jinbeh Lewisville serve?</h3>
                  ...
                  <p className="mt-4 text-charcoal/70 leading-relaxed">
                    Jinbeh Lewisville offers an extensive sashimi menu with 7 options including favorites like Salmon Sashimi, Tuna Sashimi, Yellowtail Sashimi, and more. All prepared fresh by our skilled chefs.
                  </p>
                </details>
                <details className="group border-b border-warm-ivory pb-4">
                  <summary className="flex justify-between items-center cursor-pointer list-none">
                  ...
                  <p className="mt-4 text-charcoal/70 leading-relaxed">
                    Guest favorites include Salmon Sashimi (\$14.95), Tuna Sashimi (\$16.95), Yellowtail Sashimi (\$15.95), Octopus Sashimi (\$14.95). These are consistently rated as the best sashimi in Lewisville.
                  </p>
                </details>
                <details className="group border-b border-warm-ivory pb-4">
                  <summary className="flex justify-between items-center cursor-pointer list-none">
                    <h3 className="font-medium text-charcoal pr-4">Are reservations needed for sashimi at Jinbeh Lewisville?</h3>
                    <span className="text-accent-red group-open:rotate-180 transition-transform">
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                      </svg>
                ...
                <details className="group border-b border-warm-ivory pb-4">
                  <summary className="flex justify-between items-center cursor-pointer list-none">
                    <h3 className="font-medium text-charcoal pr-4">Does Jinbeh Lewisville offer sashimi for takeout?</h3>
                    <span className="text-accent-red group-open:rotate-180 transition-transform">
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                      </svg>
                ...
                <details className="group border-b border-warm-ivory pb-4">
                  <summary className="flex justify-between items-center cursor-pointer list-none">
                    <h3 className="font-medium text-charcoal pr-4">What are sashimi prices at Jinbeh Lewisville?</h3>
                    <span className="text-accent-red group-open:rotate-180 transition-transform">
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                      </svg>
