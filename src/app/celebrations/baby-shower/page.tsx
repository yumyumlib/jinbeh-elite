...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Baby Shower" },
  ],
};
...
<section className="relative min-h-[60vh] flex items-center text-white py-20">
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-6">
            <h2 className="text-2xl font-heading font-bold text-charcoal mb-8 text-center">
              Plan Your Perfect Baby Shower
            </h2>
            <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
              <Link href="/blog/baby-shower-venues" className="group block bg-warm-ivory rounded-xl p-6 hover:shadow-lg transition-shadow">
                <span className="text-sm text-accent-red font-medium uppercase tracking-wider">Venues Guide</span>
                <h3 className="font-heading text-lg font-semibold text-charcoal mt-2 group-hover:text-accent-red transition-colors">
                  Top Baby Shower Venues in DFW
                </h3>
              ...
              <Link href="/blog/sushi-platter-near-me" className="group block bg-warm-ivory rounded-xl p-6 hover:shadow-lg transition-shadow">
                ...
                <p className="text-sm text-charcoal/70 mt-2">Order beautiful sushi platters that will wow your shower guests.</p>
              </Link>
            </div>
          </div>
        </section>
      ...
      <PageSeoBoost route="/celebrations/baby-shower" />
      <Footer />
    </>
  );
}
