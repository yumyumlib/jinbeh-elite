...
const schemas = [
    { "@context": "https://schema.org", "@type": "Article", headline: "Find Yamazaki Whiskey Nearby: Your Complete Guide", datePublished: "2026-01-30", dateModified: "2026-03-11", author: { "@type": "Organization", name: "Jinbeh Japanese Restaurant" }, image: "https://jinbeh.com/images/beverages/JapaneseWhiskey.webp" },
    {
        "@context": "https://schema.org", "@type": "FAQPage", mainEntity: [
            ...
            { "@type": "Question", name: "How much does Yamazaki whiskey cost?", acceptedAnswer: { "@type": "Answer", text: "Prices vary by expression. Yamazaki 12 Year Old typically ranges from. The NAS (no age statement) runs. Rarer expressions like the 18 Year Old can cost +." } },
                        ...
                        <article className="lg:col-span-2 bg-white rounded-3xl shadow-xl p-8 md:p-12">
                            ...
                            <table className="w-full border-collapse rounded-xl overflow-hidden shadow-md my-6">
                                ...
                                <tbody className="text-charcoal/80">
                                    <tr className="border-b bg-soft-gold/10"><td className="p-3 font-semibold">Yamazaki NAS</td><td className="p-3">Strawberry, cherry, light vanilla</td><td className="p-3">43%</td><td className="p-3"></td></tr>
 <tr className="border-b"><td className="p-3 font-semibold">⭐ Yamazaki 12</td><td className="p-3">Honey, peach, oak, pineapple</td><td className="p-3">43%</td><td className="p-3"></td></tr>
 <tr className="border-b bg-warm-ivory/30"><td className="p-3 font-semibold">Yamazaki 18</td><td className="p-3">Dark chocolate, dried fruit, sherry</td><td className="p-3">43%</td><td className="p-3">,000</td></tr>
 <tr className="border-b"><td className="p-3 font-semibold">Yamazaki 25</td><td className="p-3">Rich, complex, Mizunara wood, plum</td><td className="p-3">43%</td><td className="p-3">,000–5,000+</td></tr>
 <tr><td className="p-3 font-semibold">Sherry Cask</td><td className="p-3">Raisins, cinnamon, deep amber</td><td className="p-3">48%</td><td className="p-3">,000+</td></tr>
 </tbody>
 </table>
