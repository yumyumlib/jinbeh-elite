...
const menuSchema = {
  ...
  "@type": "Menu",
  "name": "Cocktails & Sake Menu - Jinbeh Lewisville",
  "description": "Cocktails & Sake menu at Jinbeh Japanese Restaurant in Lewisville, TX",
  "hasMenuSection": {
    "@type": "MenuSection",
    "name": "Cocktails & Sake",
    "hasMenuItem": [
...
const faqSchema = {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What cocktails & sake does Jinbeh Lewisville serve?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Jinbeh Lewisville offers an extensive cocktails & sake menu with 5 options including favorites like Sake Bomb, Jinbeh Punch, Tokyo Mule, and more. All prepared fresh by our skilled chefs."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Guest favorites include Sake Bomb ($8.00), Jinbeh Punch ($12.00), Tokyo Mule ($14.00), Lychee Martini ($13.00). These are consistently rated as the best cocktails & sake in Lewisville."
      }
    },
    {
      "@type": "Question",
      "name": "Are reservations needed for cocktails & sake at Jinbeh Lewisville?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Does Jinbeh Lewisville offer cocktails & sake for takeout?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes! Most cocktails & sake items are available for takeout and delivery. Call (214) 618-9798 or order online. "
      }
    },
    {
      "@type": "Question",
      "name": "What are cocktails & sake prices at Jinbeh Lewisville?",
      "acceptedAnswer": {
        "@type": "Answer",
...
export default function CocktailsLewisvillePage() {
  return (
    <>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg space-y-6">
                <details className="group border-b border-warm-ivory pb-4">
                  <summary className="flex justify-between items-center cursor-pointer list-none">
                    <h3 className="font-medium text-charcoal pr-4">What cocktails & sake does Jinbeh Lewisville serve?</h3>
                  ...
                  <p className="mt-4 text-charcoal/70 leading-relaxed">
                    Jinbeh Lewisville offers an extensive cocktails & sake menu with 5 options including favorites like Sake Bomb, Jinbeh Punch, Tokyo Mule, and more. All prepared fresh by our skilled chefs.
                  </p>
                </details>
                <details className="group border-b border-warm-ivory pb-4">
                  <summary className="flex justify-between items-center cursor-pointer list-none">
                  ...
                  <p className="mt-4 text-charcoal/70 leading-relaxed">
                    Guest favorites include Sake Bomb (\$8.00), Jinbeh Punch (\$12.00), Tokyo Mule (\$14.00), Lychee Martini (\$13.00). These are consistently rated as the best cocktails & sake in Lewisville.
                  </p>
                </details>
                <details className="group border-b border-warm-ivory pb-4">
                  <summary className="flex justify-between items-center cursor-pointer list-none">
                    <h3 className="font-medium text-charcoal pr-4">Are reservations needed for cocktails & sake at Jinbeh Lewisville?</h3>
                    <span className="text-accent-red group-open:rotate-180 transition-transform">
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                      </svg>
                ...
                <details className="group border-b border-warm-ivory pb-4">
                  <summary className="flex justify-between items-center cursor-pointer list-none">
                    <h3 className="font-medium text-charcoal pr-4">Does Jinbeh Lewisville offer cocktails & sake for takeout?</h3>
                    <span className="text-accent-red group-open:rotate-180 transition-transform">
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                      </svg>
                  ...
                  <p className="mt-4 text-charcoal/70 leading-relaxed">
                    Yes! Most cocktails & sake items are available for takeout and delivery. Call (214) 618-9798 or order online. 
                  </p>
                </details>
                <details className="group border-b border-warm-ivory pb-4">
                  <summary className="flex justify-between items-center cursor-pointer list-none">
                    <h3 className="font-medium text-charcoal pr-4">What are cocktails & sake prices at Jinbeh Lewisville?</h3>
                    <span className="text-accent-red group-open:rotate-180 transition-transform">
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                      </svg>
