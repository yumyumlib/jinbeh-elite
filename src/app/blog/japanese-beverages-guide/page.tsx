                    ...
                    <div className="grid lg:grid-cols-3 gap-12">
                        <article className="lg:col-span-2 bg-white rounded-3xl shadow-xl p-8 md:p-12">
                            ...
                            <div className="space-y-3">
                                {[
                                    { q: "Where can I find authentic Japanese beverages?", a: "Asian markets, specialty tea shops, and regular grocers carry Japanese beverages. Jinbeh offers traditional drinks like sake and matcha as part of our dining experience. Call Frisco (214) 618-9888 or Lewisville (214) 618-9798 for our fresh and flavorful selections!" },
