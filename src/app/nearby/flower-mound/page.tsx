...
export const metadata: Metadata = {
  title: "Japanese Restaurant Flower Mound | Hibachi & Sushi | Jinbeh",
  description: "Looking for hibachi and sushi in Flower Mound, TX? Jinbeh is only 10 minutes away in Lewisville! Authentic Japanese cuisine, teppanyaki shows, and fresh sushi. Reserve your table today.",
  keywords: [
    "japanese restaurant flower mound tx",
    "hibachi near flower mound",
    "sushi restaurants flower mound",
    "best hibachi flower mound texas",
    "teppanyaki flower mound tx",
    "japanese food flower mound",
    "hibachi restaurant flower mound",
  ],
  alternates: {
    canonical: "https://jinbeh.com/nearby/flower-mound",
  },
  openGraph: {
    title: "Japanese Restaurant Flower Mound | Hibachi & Sushi | Jinbeh",
    description: "Authentic hibachi and sushi just minutes from Flower Mound. Teppanyaki shows, fresh sushi bar, and full bar. Family-owned since 1988.",
    url: "https://jinbeh.com/nearby/flower-mound",
    type: "website",
  },
};
...
const localBusinessSchema = {
  ...
  priceRange: "$$",
  areaServed: ["Flower Mound", "Lewisville", "Frisco", "Dallas", "Texas"],
...
// FAQ Schema targeting Flower Mound keywords
const faqSchema = {
  "@context": "https://schema.org",
  "@type": "FAQPage",
  mainEntity: [
    {
      "@type": "Question",
      name: "How far is Jinbeh from Flower Mound?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Jinbeh Lewisville is located just 10 minutes from Flower Mound, making it the closest premium hibachi and sushi restaurant for Flower Mound residents. Jinbeh Frisco is also available as an alternative option, approximately 20 minutes away.",
      },
    },
    {
      "@type": "Question",
      name: "Is there hibachi near Flower Mound?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Yes! Jinbeh offers authentic teppanyaki hibachi dining with skilled chefs who cook your meal tableside. Our Lewisville location is just 10 minutes from Flower Mound.",
      },
    },
    {
      "@type": "Question",
      name: "Where is the best sushi restaurant in Flower Mound, TX?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Jinbeh Lewisville features a fresh sushi bar with master chefs preparing premium rolls, nigiri, and sashimi. Located just 10 minutes from Flower Mound at 2440 S Stemmons Fwy #A, Lewisville, TX 75067.",
      },
    },
    {
      "@type": "Question",
      name: "Why should Flower Mound residents choose Jinbeh?",
      acceptedAnswer: {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      name: "Can I make a reservation from Flower Mound?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Absolutely! You can reserve online through OpenTable or call our Lewisville location at (214) 618-9798. We highly recommend reservations, especially for dinner and weekends.",
      },
    },
    {
      "@type": "Question",
      name: "Does Jinbeh have private dining for Flower Mound groups?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Yes! We offer private hibachi dining perfect for corporate events, family celebrations, and group gatherings. Contact us at (214) 618-9798 to arrange your private event.",
      },
    },
    {
      "@type": "Question",
      name: "What are the hours for hibachi service near Flower Mound?",
      acceptedAnswer: {
        "@type": "Answer",
...
export default function FlowerMoundNearbyPage() {
  return (
    <>
      <Header />
      ...
      <main className="min-h-screen">
        ...
        <section className="hero relative bg-charcoal">
          ...
          <div className="hero-content max-w-4xl mx-auto">
            <h1 className="text-4xl md:text-6xl font-heading font-bold mb-4">
              Flower Mound&apos;s Favorite<br />Japanese Restaurant
            </h1>
            <p className="text-xl text-warm-ivory/90 mb-6">
              Only 10 minutes away in Lewisville
            </p>
          ...
          <div className="container mx-auto px-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
              <div>
                ...
                <p className="text-lg text-white/90">From Flower Mound</p>
              </div>
              <div>
                <div className="text-5xl font-bold mb-2">5.8 miles</div>
                <p className="text-lg text-white/90">Direct Route via I-35E</p>
              </div>
              <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
              <div className="card">
                ...
                <p className="text-charcoal/70">
                  Beautiful outdoor recreation area with scenic views, water activities, and waterfront dining. Perfect for a day of adventure before enjoying dinner at Jinbeh.
                </p>
              </div>
              ...
              <div className="card">
                ...
                <p className="text-charcoal/70">
                  Premier shopping destination featuring luxury retailers, fine dining, and entertainment. Combine shopping with an authentic Japanese dining experience at Jinbeh.
                </p>
              </div>
              ...
              <div className="card">
                ...
                <p className="text-charcoal/70">
                  Scenic walking trails and community gathering spaces. Enjoy an evening stroll followed by memorable hibachi dining at Jinbeh.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-16 bg-warm-ivory">
          <div className="container mx-auto px-6">
            <h2 className="font-heading text-3xl font-bold text-charcoal text-center mb-12">
              Why Flower Mound Residents Choose Jinbeh
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              ...
              <div className="card">
                ...
                <p className="text-charcoal/70">
                  Kids love watching the hibachi shows, and we have options for all ages. A favorite dining destination for Flower Mound families.
                </p>
              </div>
            </div>
          </div>
                ...
                <div className="flex items-start gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-accent-red font-semibold">
                      Closest to Flower Mound - 10 minutes
                    </p>
                  </div>
                </div>
            ...
            <div className="max-w-3xl mx-auto space-y-4">
              <details className="group border border-charcoal/20 rounded-lg p-6 cursor-pointer hover:border-accent-red transition-colors">
                <summary className="flex items-center justify-between font-semibold text-charcoal">
                  <span>How far is Jinbeh from Flower Mound?</span>
                ...
                <p className="text-charcoal/70 mt-4">
                  Jinbeh Lewisville is just 10 minutes from Flower Mound (approximately 5.8 miles via I-35E), making it the closest premium hibachi and sushi restaurant for Flower Mound residents. Jinbeh Frisco is also available about 20 minutes away.
                </p>
              </details>

              <details className="group border border-charcoal/20 rounded-lg p-6 cursor-pointer hover:border-accent-red transition-colors">
                <summary className="flex items-center justify-between font-semibold text-charcoal">
                  <span>Do you take reservations from Flower Mound?</span>
                  <svg className="w-5 h-5 text-accent-red group-open:rotate-180 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 14l-7 7m0 0l-7-7m7 7V3" />
                  </svg>
                </summary>
        ...
        <section className="py-16 bg-deep-indigo text-warm-ivory">
          <div className="container mx-auto px-6 text-center">
            ...
            <p className="text-warm-ivory/80 max-w-2xl mx-auto mb-8">
              Just 10 minutes from Flower Mound. Reserve your table today and discover why Flower Mound residents love Jinbeh for hibachi, sushi, and unforgettable dining experiences.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href={lewisvilleLocation.reservation.url}
