        ...
        },
        {
            ...
            megaMenu: [
                ...
                },
                {
                    ...
                    icon: "🎉",
                    items: [
                        { label: "Birthday Dinners", href: "/celebrations/birthday" },
                        { label: "Anniversaries", href: "/celebrations/anniversary" },
                        { label: "Corporate Events", href: "/celebrations/corporate-events" },
                        { label: "Group Dining Tips", href: "/blog/group-dining-venues" },
                    ],
                },
                {
                    title: "Local Areas",
                    icon: "📍",
                    items: [
                        { label: "Frisco Guide", href: "/frisco" },
                        { label: "Lewisville Guide", href: "/lewisville" },
                        { label: "Best of DFW", href: "/blog/category/best-of" },
                        { label: "Things to Do", href: "/blog/things-to-do-frisco" },
                    ],
                },
                {
