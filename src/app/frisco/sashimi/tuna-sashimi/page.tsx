...
export const metadata: Metadata = {
  ...
  description: "Premium ahi tuna, melt-in-your-mouth tender Enjoy Tuna Sashimi at Jinbeh Japanese Restaurant in Frisco, TX. Near Stonebriar Centre, minutes from Legacy West. Call (214) 618-9888 to reserve.",
