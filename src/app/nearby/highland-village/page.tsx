...
export const metadata: Metadata = {
  ...
  description: "Premium hibachi and sushi restaurant serving Highland Village, TX. Jinbeh is just minutes away in Frisco! Authentic Japanese cuisine, teppanyaki shows, and fresh sushi.",
  keywords: [
    "japanese restaurant highland village tx",
    "hibachi highland village texas",
    "sushi restaurants highland village",
    "best japanese food highland village tx",
    "teppanyaki near highland village",
    "hibachi restaurant highland village",
    "authentic japanese cuisine highland village",
  ],
  alternates: {
    canonical: "https://jinbeh.com/nearby/highland-village",
  },
  openGraph: {
    title: "Japanese Restaurant Highland Village TX | Hibachi & Sushi | Jinbeh",
...
const localBusinessSchema = {
  ...
  "@type": "LocalBusiness",
  name: "Jinbeh Japanese Restaurant Near Highland Village",
  image: "https://jinbeh.com/images/interior/JinbehFrisco_SushiBar.jpg",
  description: "Authentic Japanese hibachi and sushi restaurant serving Highland Village residents. Located in Frisco, just minutes away.",
  address: {
    "@type": "PostalAddress",
  ...
  priceRange: "$$",
  areaServed: ["Highland Village", "Frisco", "Lewisville", "Dallas", "Texas"],
...
// FAQ Schema targeting Highland Village keywords
const faqSchema = {
  "@context": "https://schema.org",
  "@type": "FAQPage",
  mainEntity: [
    {
      "@type": "Question",
      name: "How far is Jinbeh from Highland Village?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Jinbeh Frisco is located just 8 minutes from Highland Village, making it the closest premium hibachi and sushi restaurant for Highland Village residents. Jinbeh Lewisville is also available, approximately 12 minutes away.",
      },
    },
    {
      "@type": "Question",
      name: "Is there hibachi near Highland Village, TX?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Yes! Jinbeh offers authentic teppanyaki hibachi dining with skilled chefs who cook your meal tableside. Our Frisco location is just 8 minutes from Highland Village.",
      },
    },
    {
      "@type": "Question",
      name: "Where is the best sushi restaurant near Highland Village?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Jinbeh Frisco features a fresh sushi bar with master chefs preparing premium rolls, nigiri, and sashimi. Located just minutes from Highland Village at 2693 Preston Rd Suite 1040, Frisco, TX 75034.",
      },
    },
    {
      "@type": "Question",
      name: "Why should Highland Village residents choose Jinbeh?",
      acceptedAnswer: {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      name: "Can I make a reservation from Highland Village?",
      acceptedAnswer: {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      name: "Does Jinbeh offer private dining for Highland Village groups?",
      acceptedAnswer: {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      name: "What are the hours for hibachi service near Highland Village?",
      acceptedAnswer: {
        "@type": "Answer",
...
export default function HighlandVillageNearbyPage() {
  return (
    <>
      <Header />
        ...
        <section className="hero relative bg-charcoal">
          ...
          <div className="hero-content max-w-4xl mx-auto">
            <h1 className="text-4xl md:text-6xl font-heading font-bold mb-4">
              Highland Village&apos;s Premier Japanese Restaurant<br />Is Just Minutes Away
            </h1>
            <p className="text-xl text-warm-ivory/90 mb-6">
              Only 8 minutes from Highland Village
            </p>
          ...
          <div className="container mx-auto px-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
              <div>
                ...
                <p className="text-lg text-white/90">From Highland Village</p>
              </div>
              <div>
                <div className="text-5xl font-bold mb-2">5.2 miles</div>
        ...
        <section className="py-16 bg-warm-ivory">
          <div className="container mx-auto px-6">
            <h2 className="font-heading text-3xl font-bold text-charcoal text-center mb-12">
              Why Highland Village Residents Choose Jinbeh
            </h2>
 ...
 <p className="text-charcoal/70">
 Kids love watching the hibachi shows, and we have options for all ages. A favorite dining destination for Highland Village families.
 </p>
 </div>
 </div>
 </div>
 ...
 Closest to Highland Village - 8 minutes
 </p>
 </div>
 </div>
 ...
 <span>How far is Jinbeh from Highland Village?</span>
 ...
 Jinbeh Frisco is just 8 minutes from Highland Village (approximately 5.2 miles), making it the closest premium hibachi and sushi restaurant for Highland Village residents. Jinbeh Lewisville is an alternative option about 12 minutes away.
 </p>
 </details>

 <details className="group border border-charcoal/20 rounded-lg p-6 cursor-pointer hover:border-accent-red transition-colors">
 <summary className="flex items-center justify-between font-semibold text-charcoal">
 <span>Do you take reservations from Highland Village?</span>
 <svg className="w-5 h-5 text-accent-red group-open:rotate-180 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
 <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 14l-7 7m0 0l-7-7m7 7V3" />
 </svg>
 </summary>
 ...
 Jinbeh combines nearly 40 years of family tradition with authentic Japanese cuisine, skilled teppanyaki chefs, a fresh sushi bar, and a commitment to exceptional service. We're not just a restaurant, we're an experience that creates lasting memories.
        ...
        <section className="py-16 bg-deep-indigo text-warm-ivory">
          <div className="container mx-auto px-6 text-center">
            ...
            <p className="text-warm-ivory/80 max-w-2xl mx-auto mb-8">
              Just 8 minutes from Highland Village. Reserve your table today and discover why Highland Village residents love Jinbeh for hibachi, sushi, and unforgettable dining experiences.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href={friscoLocation.reservation.url}
      ...
      <PageSeoBoost route="/nearby/highland-village" />
