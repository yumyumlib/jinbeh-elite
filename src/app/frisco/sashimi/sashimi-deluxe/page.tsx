...
export const metadata: Metadata = {
  ...
  description: "Chef\'s selection of premium fish Enjoy Sashimi Deluxe Platter at Jinbeh Japanese Restaurant in Frisco, TX. Near Stonebriar Centre, minutes from Legacy West. Call (214) 618-9888 to reserve.",
