...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://jinbeh.com/celebrations/national-fried-rice-day",
  },
};
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "National Fried Rice Day" },
  ],
};
...
<section className="relative h-[70vh] min-h-[500px] flex items-center justify-center overflow-hidden">
        ...
        <section className="py-16 bg-warm-ivory">
          <div className="container mx-auto px-6">
            ...
            <div className="flex flex-wrap justify-center gap-3 max-w-3xl mx-auto text-sm">
              ...
              <Link href="/blog/discover-teppanyaki" className="px-4 py-2 bg-white rounded-full text-charcoal hover:bg-accent-red hover:text-white transition-colors">Hibachi Guide</Link>
      ...
      <PageSeoBoost route="/celebrations/national-fried-rice-day" />
      <Footer />
    </>
  );
}
