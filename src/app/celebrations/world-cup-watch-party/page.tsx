...
export const metadata: Metadata = {
 title:
 "soccer watch party with Chioma Ubogagu | June 25 | Jinbeh Frisco & Lewisville",
 description:
 "Join the international soccer tournament Watch Party at Jinbeh on Thursday, June 25. Professional soccer player and Coppell native Chioma Ubogagu (Dallas Trinity FC) appears in Lewisville. Two big screens, a halftime signed-merchandise giveaway at both locations, and the Samurai Blue Special. Reserve at jinbeh.com.",
 keywords: [
 "soccer watch party frisco",
 "soccer watch party lewisville",
 "japan soccer watch party dallas",
 "where to watch soccer frisco tx",
 "chioma ubogagu jinbeh",
 "dallas trinity fc watch party",
 "things to do june 25 frisco",
 "att stadium soccer restaurant",
 "japanese restaurant near att stadium",
 "samurai blue dfw",
 "hibachi frisco",
 "sushi lewisville",
 "jinbeh soccer watch party",
 "where to watch the semifinal dfw",
 "restaurants near dallas stadium",
 "family friendly soccer watch party dfw",
 "restaurant with big screens to watch soccer dfw",
 "donde ver el partido dallas",
 ],
 openGraph: {
 title:
 "soccer watch party with Chioma Ubogagu | June 25 | Jinbeh",
 description:
 ...
 width: 1200,
 height: 630,
 alt: "soccer watch party with Chioma Ubogagu at Jinbeh Frisco and Lewisville on June 25",
 },
 ],
 type: "website",
 },
...
const eventSchema = {
 ...
 {
 "@type": "Event",
 name: "soccer watch party at Jinbeh Frisco",
 startDate: "2026-06-25T17:00:00-05:00",
 endDate: "2026-06-25T22:00:00-05:00",
 eventAttendanceMode: "https://schema.org/OfflineEventAttendanceMode",
 eventStatus: "https://schema.org/EventScheduled",
 description:
 "international soccer tournament Watch Party for Japan's match. Two big screens, a halftime giveaway of signed merchandise, hibachi with a show, and the Samurai Blue Special.",
 image:
 "https://jinbeh.com/images/celebrations/world-cup-watch-party.jpg",
 location: {
 "@type": "Place",
...
const faqSchema = {
 ...
 {
 "@type": "Question",
 name: "When is the Jinbeh soccer watch party with Chioma Ubogagu?",
 acceptedAnswer: {
 "@type": "Answer",
 text: "Thursday, June 25, 2026. The party starts at 5:00 PM, Japan's tournament match kicks off at 6:00 PM CT, and both locations stay open until 10:00 PM. Chioma Ubogagu appears in person at Jinbeh Lewisville.",
 },
 },
 {
 "@type": "Question",
 ...
 acceptedAnswer: {
 "@type": "Answer",
 text: "In honor of Japan's soccer tournament run, Jinbeh is serving its popular sashimi combination with a complimentary side of edamame, available at both locations through the tournament.",
 },
 },
 {
 "@type": "Question",
 name: "Can I watch other tournament matches at Jinbeh?",
 acceptedAnswer: {
 "@type": "Answer",
 text: "Yes. Jinbeh shows every tournament match through July 19 at both the Frisco and Lewisville locations, including the knockout rounds and the semifinal in Dallas.",
 },
 },
 ],
};
...
export default function WorldCupWatchPartyPage() {
 ...
 alt="soccer watch party Frisco at Jinbeh Japanese restaurant"
 fill
 sizes="100vw"
 ...
 soccer watch party with Chioma Ubogagu
 </h1>
 <p className="text-lg md:text-xl text-warm-ivory/90 mb-8 max-w-2xl mx-auto">
 Coppell&apos;s own pro soccer star comes home for the tournament,
 ...
 <p className="text-charcoal/80 mb-4">
 On the night Japan plays the tournament in Arlington, Chioma is
 ...
 <li>Two big screens showing Japan&apos;s tournament match</li>
 ...
 In honor of Japan&apos;s soccer tournament run, enjoy our popular sashimi
 ...
 June 25 is the big one, but the tournament runs through July 19, and
 ...
 full soccer tournament at Jinbeh page
 </Link>{" "}
