    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Jinbeh Japanese Restaurant — Frisco Sushi Rolls",
      },
    ],
  },
  alternates: {
  ...
  "mainEntity": [
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Jinbeh Frisco offers an extensive sushi rolls menu with 17 options including favorites like Dragon Roll, Rainbow Roll, Spider Roll, and more. All prepared fresh by our skilled chefs."
      }
    },
    {
      "@type": "Question",
  ...
  return (
    <>
      ...
      <div className="container mx-auto max-w-6xl px-4 lg:px-6">
        <BreadcrumbNav items={[{ label: "Frisco", href: "/frisco" }, { label: "Sushi Rolls" }]} />
      </div>
...
Pricing is listed on our current menu. Browse the full menu for details.
        ...
        <CategoryLocationSEO locationId="frisco" category="sushi-rolls" />
