...
export const metadata: Metadata = {
  title: "Japanese Restaurant Near McKinney | Hibachi & Sushi | Jinbeh",
  description: "Looking for hibachi and sushi near McKinney, TX? Jinbeh is just 15 minutes away in Frisco! Authentic Japanese cuisine, teppanyaki shows, and fresh sushi. Reserve your table today.",
  keywords: [
    "japanese restaurant mckinney tx",
    "hibachi near mckinney",
    "sushi restaurants mckinney texas",
    "best hibachi mckinney",
    "teppanyaki near mckinney tx",
    "japanese food mckinney",
    "hibachi restaurant near mckinney",
  ],
  alternates: {
    canonical: "https://jinbeh.com/nearby/mckinney",
  },
  openGraph: {
    title: "Japanese Restaurant Near McKinney | Hibachi & Sushi | Jinbeh",
    description: "Authentic hibachi and sushi just minutes from McKinney. Teppanyaki shows, fresh sushi bar, and full bar. Family-owned since 1988.",
...
const localBusinessSchema = {
  ...
  "@type": "LocalBusiness",
  name: "Jinbeh Japanese Restaurant Near McKinney",
  image: "https://jinbeh.com/images/frisco-interior.jpg",
  description: "Authentic Japanese hibachi and sushi restaurant serving McKinney residents. Located in Frisco, just minutes away.",
  address: {
    "@type": "PostalAddress",
  ...
  priceRange: "$$",
  areaServed: ["McKinney", "Frisco", "Lewisville", "Dallas", "Texas"],
...
// FAQ Schema targeting McKinney keywords
const faqSchema = {
  "@context": "https://schema.org",
  "@type": "FAQPage",
  mainEntity: [
    {
      "@type": "Question",
      name: "How far is Jinbeh from McKinney?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Jinbeh Frisco is located just 15 minutes from downtown McKinney, making it the closest premium hibachi and sushi restaurant for McKinney residents. Jinbeh Lewisville is also available as an alternative option.",
      },
    },
    {
      "@type": "Question",
      name: "Is there hibachi near McKinney?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Yes! Jinbeh offers authentic teppanyaki hibachi dining with skilled chefs who cook your meal tableside. Our Frisco location is just 15 minutes from McKinney.",
      },
    },
    {
      "@type": "Question",
      name: "Where is the best sushi restaurant near McKinney, TX?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Jinbeh Frisco features a fresh sushi bar with master chefs preparing premium rolls, nigiri, and sashimi. Located just minutes from McKinney at 2693 Preston Rd Suite 1040, Frisco, TX 75034.",
      },
    },
    {
      "@type": "Question",
      name: "Why should McKinney residents choose Jinbeh?",
      acceptedAnswer: {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      name: "What are the hours for hibachi service near McKinney?",
      acceptedAnswer: {
        "@type": "Answer",
...
export default function McKinneyNearbyPage() {
  return (
    <>
      <Header />
      ...
      <main className="min-h-screen">
        ...
        <section className="hero relative bg-charcoal">
          ...
          <div className="hero-content max-w-4xl mx-auto">
            <h1 className="text-4xl md:text-6xl font-heading font-bold mb-4">
              McKinney&apos;s Best Japanese Dining<br />Awaits at Jinbeh
            </h1>
            <p className="text-xl text-warm-ivory/90 mb-6">
              Only 15 minutes from downtown McKinney
            </p>
        ...
        <section className="py-16 bg-accent-red text-white">
          <div className="container mx-auto px-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
              <div>
                <div className="text-5xl font-bold mb-2">15 mins</div>
                <p className="text-lg text-white/90">From Downtown McKinney</p>
              </div>
              <div>
                <div className="text-5xl font-bold mb-2">10.8 miles</div>
                <p className="text-lg text-white/90">Direct Route via US-75</p>
              </div>
              <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
              <div className="card">
                ...
                <p className="text-charcoal/70">
                  Explore historic Chestnut Square, boutique shops, and charming restaurants in McKinney's vibrant downtown district, just minutes from Jinbeh.
                </p>
              </div>
              ...
              <div className="card">
                ...
                <p className="text-charcoal/70">
                  Mediterranean-style shopping destination with premium retailers and dining options. Perfect for a full day of entertainment and shopping.
                </p>
              </div>
              ...
              <div className="card">
                ...
                <p className="text-charcoal/70">
                  World-class theater and performances. Celebrate your evening with dinner at Jinbeh followed by a show at this stunning venue.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-16 bg-warm-ivory">
          <div className="container mx-auto px-6">
            <h2 className="font-heading text-3xl font-bold text-charcoal text-center mb-12">
              Why McKinney Residents Choose Jinbeh
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              ...
              <div className="card">
                ...
                <p className="text-charcoal/70">
                  Kids love watching the hibachi shows, and we have options for all ages. A favorite dining destination for McKinney families.
                </p>
              </div>
            </div>
          </div>
                ...
                <div className="flex items-start gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-accent-red font-semibold">
                      Closest to McKinney - 15 minutes
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-cedar-brown font-semibold">
                      Alternative Option - Variable Distance
                    </p>
                  </div>
                </div>
            ...
            <div className="max-w-3xl mx-auto space-y-4">
              <details className="group border border-charcoal/20 rounded-lg p-6 cursor-pointer hover:border-accent-red transition-colors">
                <summary className="flex items-center justify-between font-semibold text-charcoal">
                  <span>How far is Jinbeh from downtown McKinney?</span>
                ...
                <p className="text-charcoal/70 mt-4">
                  Jinbeh Frisco is just 15 minutes from downtown McKinney (approximately 10.8 miles via US-75), making it the closest premium hibachi and sushi restaurant for McKinney residents. Jinbeh Lewisville is also available as an alternative option.
                </p>
              </details>

              <details className="group border border-charcoal/20 rounded-lg p-6 cursor-pointer hover:border-accent-red transition-colors">
                <summary className="flex items-center justify-between font-semibold text-charcoal">
                  <span>Do you take reservations from McKinney?</span>
                  <svg className="w-5 h-5 text-accent-red group-open:rotate-180 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 14l-7 7m0 0l-7-7m7 7V3" />
                  </svg>
                </summary>
        ...
        <section className="py-16 bg-deep-indigo text-warm-ivory">
          <div className="container mx-auto px-6 text-center">
            ...
            <p className="text-warm-ivory/80 max-w-2xl mx-auto mb-8">
              Just 15 minutes from downtown McKinney. Reserve your table today and discover why McKinney residents love Jinbeh for hibachi, sushi, and unforgettable dining experiences.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href={friscoLocation.reservation.url}
