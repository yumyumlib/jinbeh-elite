...
const faqSchema = {
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Pair this with drinks from our Happy Hour (Mon-Fri 5:00-6:30 PM). Enjoy draft beer, sake, and wine alongside favorites like Soft Shell Crab. Call (214) 488-2224 for details."
      }
    },
    {
      "@type": "Question",
...
export default function SoftShellCrabLewisvillePage() {
  ...
  return (
    <>
      ...
      <PageSeoBoost route="/lewisville/appetizers/soft-shell-crab" />
      <Footer />
    </>
  );
}
