...
export const metadata: Metadata = {
  ...
  description: "Three premium sake tasting flight at Jinbeh Lewisville. Experience authentic Japanese sakes with expert guidance. Best sake selection near Vista Ridge (214) 488-2224.",
