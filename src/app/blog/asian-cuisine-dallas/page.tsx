    ...
    return (
        ...
        />
            ...
            <section className="relative h-[50vh] min-h-[400px] flex items-end overflow-hidden">
                <Image src="/images/hero/jinbeh-hibachi-chef-fire-show-mobile-1500.webp" alt="Asian Cuisine Dallas at Jinbeh Japanese restaurant" fill className="object-cover" priority />
