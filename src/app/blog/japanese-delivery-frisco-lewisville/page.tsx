    ...
    return (
        <main id="main-content" className="min-h-screen bg-warm-ivory">
            ...
            <section className="relative h-[55vh] min-h-[460px] flex items-end overflow-hidden">
                <Image src="/images/photoshoot/hibachi-plate-shrimp.jpg" alt="Japanese Delivery Frisco at Jinbeh Frisco Japanese restaurant" fill className="object-cover" priority sizes="100vw" />
