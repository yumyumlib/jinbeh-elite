...
const faqSchema = {
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Guest favorites include Sake Bomb, Jinbeh Punch, Tokyo Mule, and Lychee Martini. These are consistently rated as the best cocktails & sake in Lewisville."
      }
    },
    {
      "@type": "Question",
    ...
    {
      "@type": "Question",
      "name": "Where can I view the cocktails & sake menu for Jinbeh Lewisville?",
      "acceptedAnswer": {
        "@type": "Answer",
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg space-y-6">
                ...
                <details className="group border-b border-warm-ivory pb-4">
                  ...
                  <p className="mt-4 text-charcoal/70 leading-relaxed">
                    Guest favorites include Sake Bomb, Jinbeh Punch, Tokyo Mule, and Lychee Martini. These are consistently rated as the best cocktails & sake in Lewisville.
                  </p>
                </details>
                <details className="group border-b border-warm-ivory pb-4">
                  <summary className="flex justify-between items-center cursor-pointer list-none">
