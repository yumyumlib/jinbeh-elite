    ...
    return (
        <main id="main-content" className="min-h-screen bg-warm-ivory">
            ...
            <section className="relative h-[55vh] min-h-[460px] flex items-end overflow-hidden">
                <Image src="/images/photoshoot/jinbeh-hibachi-sushi-feast-frisco-lewisville.jpg" alt="Kid Friendly Japanese Restaurants Dfw at Jinbeh Japanese restaurant" fill className="object-cover" priority sizes="100vw" />
