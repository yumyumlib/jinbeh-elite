...
export const metadata: Metadata = {
  ...
  description: "Best sushi restaurant in Grapevine, TX. Jinbeh offers fresh premium sushi and authentic Japanese cuisine just minutes from Grapevine in Frisco. Reserve your table for an exceptional dining experience.",
  keywords: [
    "sushi grapevine tx",
    "sushi restaurant grapevine texas",
    "best sushi grapevine",
    "japanese food grapevine tx",
    "sushi bar grapevine",
    "premium sushi grapevine",
    "sushi near grapevine",
  ],
  alternates: {
    canonical: "https://jinbeh.com/nearby/grapevine",
  },
  openGraph: {
    title: "Sushi Grapevine TX | Premium Sushi Restaurant | Jinbeh",
...
const localBusinessSchema = {
  ...
  "@type": "LocalBusiness",
  name: "Jinbeh Sushi Restaurant Near Grapevine",
  image: "https://jinbeh.com/images/frisco-interior.jpg",
  description: "Premium sushi restaurant and Japanese hibachi serving Grapevine residents. Located in Frisco, just minutes away with fresh sushi bar.",
  address: {
    "@type": "PostalAddress",
  ...
  priceRange: "$$",
  areaServed: ["Grapevine", "Frisco", "Lewisville", "Dallas", "Texas"],
...
// FAQ Schema targeting Grapevine keywords
const faqSchema = {
  "@context": "https://schema.org",
  "@type": "FAQPage",
  mainEntity: [
    {
      "@type": "Question",
      name: "Where is the best sushi restaurant in Grapevine?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Jinbeh Frisco offers the finest premium sushi in the area, just 15 minutes from Grapevine. Our master sushi chefs prepare fresh rolls, nigiri, and sashimi daily with the highest quality ingredients.",
      },
    },
    {
      "@type": "Question",
      name: "How far is Jinbeh sushi from Grapevine?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Jinbeh Frisco is located just 15 minutes from Grapevine, making it the premier sushi destination for Grapevine residents. Jinbeh Lewisville is also available, approximately 17 minutes away.",
      },
    },
    {
      "@type": "Question",
    ...
    {
      "@type": "Question",
      name: "Do you offer fresh sushi rolls in Grapevine at Jinbeh?",
      acceptedAnswer: {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      name: "What are the sushi menu hours in Grapevine?",
      acceptedAnswer: {
        "@type": "Answer",
...
export default function GrapevineNearbyPage() {
  return (
    <>
      <Header />
      ...
      <main className="min-h-screen">
        ...
        <section className="hero relative bg-charcoal">
          ...
          <div className="hero-content max-w-4xl mx-auto">
            <h1 className="text-4xl md:text-6xl font-heading font-bold mb-4">
              Grapevine&apos;s Premier Sushi Bar<br />Is Just 15 Minutes Away
            </h1>
            ...
            <p className="text-lg text-warm-ivory/80 max-w-2xl mx-auto mb-8">
              Experience the artistry of master sushi chefs at Jinbeh. Fresh premium ingredients, creative specialty rolls, and traditional techniques combine to create exceptional sushi experiences for Grapevine residents.
            </p>
          ...
          <div className="container mx-auto px-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
              <div>
                ...
                <p className="text-lg text-white/90">From Grapevine</p>
              </div>
              <div>
                <div className="text-5xl font-bold mb-2">9.5 miles</div>
        ...
        <section className="py-16 bg-warm-ivory">
          <div className="container mx-auto px-6">
            <h2 className="font-heading text-3xl font-bold text-charcoal text-center mb-12">
              Why Grapevine Residents Choose Jinbeh for Sushi
            </h2>
        ...
        <section className="py-16 bg-warm-ivory">
          <div className="container mx-auto px-6">
            <h2 className="font-heading text-3xl font-bold text-charcoal text-center mb-12">
              Sushi Questions from Grapevine
            </h2>
            <div className="max-w-3xl mx-auto space-y-4">
              <details className="group border border-charcoal/20 rounded-lg p-6 cursor-pointer hover:border-accent-red transition-colors">
                <summary className="flex items-center justify-between font-semibold text-charcoal">
                  <span>How far is the sushi bar from Grapevine?</span>
                ...
                <p className="text-charcoal/70 mt-4">
                  Jinbeh Frisco is just 15 minutes from Grapevine (approximately 9.5 miles), making it the closest premium sushi bar for Grapevine residents. Jinbeh Lewisville is an alternative option about 17 minutes away.
                </p>
              </details>

              <details className="group border border-charcoal/20 rounded-lg p-6 cursor-pointer hover:border-accent-red transition-colors">
                <summary className="flex items-center justify-between font-semibold text-charcoal">
                  <span>Can I book a sushi reservation from Grapevine?</span>
                  <svg className="w-5 h-5 text-accent-red group-open:rotate-180 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 14l-7 7m0 0l-7-7m7 7V3" />
                  </svg>
                </summary>
        ...
        <section className="py-16 bg-deep-indigo text-warm-ivory">
          <div className="container mx-auto px-6 text-center">
            ...
            <p className="text-warm-ivory/80 max-w-2xl mx-auto mb-8">
              Just 15 minutes from Grapevine. Reserve your table at our sushi bar today and discover why Grapevine residents choose Jinbeh for the finest sushi and Japanese cuisine.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href={friscoLocation.reservation.url}
