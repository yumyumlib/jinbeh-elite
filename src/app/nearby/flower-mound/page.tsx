...
export const metadata: Metadata = {
  ...
  description: "Looking for hibachi and sushi in Flower Mound, TX? Jinbeh is only 10 minutes away in Lewisville! Authentic Japanese cuisine, teppanyaki shows, and fresh sushi. Reserve.",
  keywords: [
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Jinbeh Japanese Restaurant — Nearby Flower Mound",
      },
    ],
    type: "website",
  },
...
export default function FlowerMoundNearbyPage() {
      ...
      <main id="main-content" className="min-h-screen">
        ...
        <section className="hero relative bg-charcoal">
          <div
            ...
            style={{
              backgroundImage: "url('/images/lewisville/IMG_1975.jpg')",
            }}
          />
 ...
 Jinbeh combines nearly 40 years of family tradition with authentic Japanese cuisine, skilled teppanyaki chefs, a fresh sushi bar, and a commitment to exceptional service. We're not just a restaurant, we're an experience that creates lasting memories.
      ...
      <PageSeoBoost route="/nearby/flower-mound" />
