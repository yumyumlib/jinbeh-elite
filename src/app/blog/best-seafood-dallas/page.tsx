    ...
    return (
        ...
        />
            ...
            <section className="relative h-[50vh] min-h-[400px] flex items-end overflow-hidden">
                <Image src="/images/hero/jinbeh-hibachi-chef-flames-frisco-lewisville.jpg" alt="Best Seafood Dallas at Jinbeh Japanese restaurant" fill className="object-cover" priority />
