...
export const metadata: Metadata = {
  ...
  description: "Tasting of three premium sakes Enjoy Sake Flight at Jinbeh Japanese Restaurant in Lewisville, TX. Easy access from I-35E, near Vista Ridge Mall. Call (214) 618-9798 to reserve.",
  ...
  "mainEntity": [
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The Sake Flight at Jinbeh Lewisville is tasting of three premium sakes. At $18.00, it's one of our signature bar offerings."
      }
    },
    {
      "@type": "Question",
        ...
        <nav className="bg-white border-b border-warm-ivory-dark">
          <div className="container mx-auto px-6 py-3">
            <ol className="flex items-center gap-2 text-sm text-charcoal/60">
              ...
              <li>/</li>
              <li className="text-charcoal font-medium">Sake Flight</li>
            </ol>
          </div>
        </nav>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg mb-8">
                ...
                <p className="text-charcoal/80 leading-relaxed mb-6">
                  Experience the exceptional Sake Flight at Jinbeh Lewisville.
                  Tasting of three premium sakes Our skilled chefs craft this dish with precision and artistry.
                </p>
                <p className="text-charcoal/80 leading-relaxed">
                  ...
                  Sake Flight is a guest favorite that delivers on both flavor and presentation.
                </p>
              </div>
                ...
                <div className="space-y-6">
                  <details className="group border-b border-warm-ivory pb-4">
                    <summary className="flex justify-between items-center cursor-pointer list-none">
                      <h3 className="font-medium text-charcoal pr-4">What is the Sake Flight at Jinbeh?</h3>
                    ...
                    <p className="mt-4 text-charcoal/70 leading-relaxed">
                      The Sake Flight at Jinbeh Lewisville is tasting of three premium sakes. At \$18.00, it\'s one of our signature bar offerings.
                    </p>
                  </details>
                  <details className="group border-b border-warm-ivory pb-4">
                    <summary className="flex justify-between items-center cursor-pointer list-none">
                      <h3 className="font-medium text-charcoal pr-4">Is Sake Flight available during happy hour?</h3>
                      <span className="text-accent-red group-open:rotate-180 transition-transform">
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                        </svg>
                    ...
                    <p className="mt-4 text-charcoal/70 leading-relaxed">
                      Many of our cocktails including options like Sake Flight are featured during happy hour at discounted prices. Visit Jinbeh Lewisville for current happy hour specials.
                    </p>
                  </details>
                  <details className="group border-b border-warm-ivory pb-4">
                    <summary className="flex justify-between items-center cursor-pointer list-none">
                      <h3 className="font-medium text-charcoal pr-4">What food pairs with Sake Flight?</h3>
                      <span className="text-accent-red group-open:rotate-180 transition-transform">
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                        </svg>
                    ...
                    <p className="mt-4 text-charcoal/70 leading-relaxed">
                      Sake Flight pairs beautifully with our sushi and appetizers. Our bartenders can suggest the perfect food pairing to complement your drink.
                    </p>
                  </details>
                  <details className="group border-b border-warm-ivory pb-4">
                    <summary className="flex justify-between items-center cursor-pointer list-none">
                      <h3 className="font-medium text-charcoal pr-4">Can I get Sake Flight at the bar?</h3>
                      <span className="text-accent-red group-open:rotate-180 transition-transform">
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                        </svg>
                    ...
                    <p className="mt-4 text-charcoal/70 leading-relaxed">
                      Yes! Jinbeh Lewisville has a full bar where you can enjoy Sake Flight and watch our sushi chefs at work. No reservation needed for bar seating.
                    </p>
                  </details>
                </div>
              </div>
