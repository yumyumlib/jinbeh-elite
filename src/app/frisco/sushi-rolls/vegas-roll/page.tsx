  ...
  return (
    <>
      ...
      <div className="container mx-auto max-w-6xl px-4 lg:px-6">
        <BreadcrumbNav items={[{ label: "Frisco", href: "/frisco" }, { label: "Sushi Rolls", href: "/frisco/sushi-rolls" }, { label: "Vegas Roll" }]} />
      </div>
      <div>
      ...
      <PageSeoBoost route="/frisco/sushi-rolls/vegas-roll" />
      <Footer />
    </>
  );
}
