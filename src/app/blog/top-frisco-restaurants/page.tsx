...
const faqSchema = {
    ...
    mainEntity: [
        ...
        },
        {
            ...
            acceptedAnswer: {
                "@type": "Answer",
                text: "Jinbeh consistently receives top ratings for Japanese cuisine and hibachi experiences, with a top-rated Google rating reflecting commitment to fresh ingredients, expert preparation, and authentic flavors.",
            },
        },
        {
            "@type": "Question",
...
const itemListSchema = {
  "@context": "https://schema.org",
  "@type": "ItemList",
  "name": "Top 10 Frisco Restaurants: Must-Try Dining Spots in Texas",
  "numberOfItems": 8,
  "itemListElement": [
    {
      "@type": "ListItem",
      "position": 1,
      "name": "1. Jinbeh Japanese Restaurant ⭐ Top Pick"
    },
    {
      "@type": "ListItem",
      "position": 2,
      "name": "2. Babe's Chicken Dinner House"
    },
    {
      "@type": "ListItem",
      "position": 3,
      "name": "3. The Heritage Table"
    },
    {
      "@type": "ListItem",
      "position": 4,
      "name": "4. Dee Lincoln Prime"
    },
    {
      "@type": "ListItem",
      "position": 5,
    ...
    },
    {
      "@type": "ListItem",
      "position": 6,
      "name": "Why Jinbeh Stands Apart"
    },
    {
      "@type": "ListItem",
      "position": 7,
      "name": "What Makes Frisco a Dining Destination?"
    },
    {
      "@type": "ListItem",
      "position": 8,
      "name": "Frisco Dining by Cuisine"
    }
  ]
};
        ...
        />
            ...
            <section className="relative h-[60vh] min-h-[500px] flex items-end overflow-hidden">
                <Image
                    ...
                    alt="Overhead view of hibachi steak plate with fried rice and grilled vegetables at Jinbeh"
                    fill
                        ...
                        <article className="lg:col-span-2">
                            <div className="bg-white rounded-3xl shadow-xl p-8 md:p-12">
                                <div className="prose prose-lg max-w-none">
                                    ...
                                    <p>
                                        <strong>Why visit:</strong> Hibachi entertainment, fresh sushi, top-rated Google rating, extensive menu<br />
                                ...
                                <div className="mt-16">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <details className="group bg-warm-ivory rounded-2xl overflow-hidden">
                                            ...
                                            <div className="px-6 pb-6 text-charcoal/80">
                                                <p>
                                                    While "best" is subjective, Jinbeh consistently receives top ratings for Japanese cuisine and hibachi. Our top-rated Google rating reflects our commitment to fresh ingredients, expert preparation, and authentic flavors.
                                                </p>
                                            </div>
                                        </details>
                            ...
                            <div className="bg-white rounded-3xl shadow-xl p-6 sticky top-24">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <Link href="/blog/best-sushi-frisco" className="flex gap-4 group">
                                        <div className="relative w-20 h-16 rounded-xl overflow-hidden flex-shrink-0 bg-warm-ivory">
                                            <Image src="/images/blog/jinbeh-frisco-steak-hibachi-overhead-logo-plate.jpg" alt="Overhead view of hibachi steak plate with fried rice and grilled vegetables at Jinbeh" fill className="object-cover group-hover:scale-105 transition-transform" />
                                        </div>
                                        <div className="flex-1 min-w-0">
