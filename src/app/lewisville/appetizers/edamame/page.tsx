...
export const metadata: Metadata = {
  ...
  description: "Steamed soybeans with sea salt Enjoy Edamame at Jinbeh Japanese Restaurant in Lewisville, TX. Easy access from I-35E, near Vista Ridge Mall. Call (214) 618-9798 to reserve.",
...
const faqSchema = {
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Check our happy hour specials! Many appetizers including items similar to Edamame are featured during our happy hour. Call (214) 618-9798 for current specials."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes, Edamame travels well for takeout. Call (214) 618-9798 directly or order online."
      }
    }
  ]
};
                ...
                <div className="space-y-6">
                  <details className="group border-b border-warm-ivory pb-4">
                    ...
                    <p className="mt-4 text-charcoal/70 leading-relaxed">
                      Edamame at Jinbeh Lewisville is steamed soybeans with sea salt. At \$5.95, it\'s perfect for sharing while you wait for your hibachi or sushi.
                    </p>
                  </details>
                  <details className="group border-b border-warm-ivory pb-4">
                    <summary className="flex justify-between items-center cursor-pointer list-none">
                    ...
                    <p className="mt-4 text-charcoal/70 leading-relaxed">
                      Yes! Edamame is designed for sharing. It\'s one of our most popular starters for groups dining at Jinbeh Lewisville.
                    </p>
                  </details>
                  <details className="group border-b border-warm-ivory pb-4">
                    <summary className="flex justify-between items-center cursor-pointer list-none">
                    ...
                    <p className="mt-4 text-charcoal/70 leading-relaxed">
                      Check our happy hour specials! Many appetizers including items similar to Edamame are featured during our happy hour. Call (214) 618-9798 for current specials.
                    </p>
                  </details>
                  <details className="group border-b border-warm-ivory pb-4">
                    <summary className="flex justify-between items-center cursor-pointer list-none">
                    ...
                    <p className="mt-4 text-charcoal/70 leading-relaxed">
                      Yes, Edamame travels well for takeout. Call (214) 618-9798 directly or order online.
                    </p>
                  </details>
                </div>
              </div>
