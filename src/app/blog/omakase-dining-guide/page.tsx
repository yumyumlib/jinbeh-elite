...
const schemas = [
    { "@context": "https://schema.org", "@type": "Article", headline: "Japanese Omakase: Unraveling the Unique Dining Art", datePublished: "2026-01-25", dateModified: "2026-03-11", author: { "@type": "Organization", name: "Jinbeh Japanese Restaurant" }, image: "https://jinbeh.com/images/blog/17-C060324-6708.jpg" },
    {
        "@context": "https://schema.org", "@type": "FAQPage", mainEntity: [
            ...
            { "@type": "Question", name: "How do I book an omakase experience at Jinbeh?", acceptedAnswer: { "@type": "Answer", text: "Call Jinbeh directly to arrange your omakase experience. Booking 1-2 weeks in advance is recommended. Frisco: (214) 619-1200, Lewisville: (214) 488-2224." } }
        ]
    }
];
...
export default function OmakaseDiningGuide() {
    return (
        ...
        <div className="container mx-auto max-w-6xl px-4 lg:px-6">
          <BreadcrumbNav items={[{ label: "Blog", href: "/blog" }, { label: "Omakase Dining Guide" }]} />
        </div>
            <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(breadcrumbSchema) }} />
            {schemas.map((s, i) => <script key={i} type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(s) }} />)}

            <section className="relative h-[50vh] min-h-[400px] flex items-end overflow-hidden">
                <Image src="/images/photoshoot/sushi-tower.jpg" alt="Omakase at Jinbeh Japanese restaurant" fill className="object-cover" priority />
