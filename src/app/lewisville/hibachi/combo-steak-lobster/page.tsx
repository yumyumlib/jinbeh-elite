...
export const metadata: Metadata = {
  title: "Steak & Lobster Combo | Jinbeh Lewisville Hibachi Menu",
  description: "Surf and turf perfection Enjoy Steak & Lobster Combo at Jinbeh Japanese Restaurant in Lewisville, TX. Easy access from I-35E, near Vista Ridge Mall. Call (214) 618-9798 to reserve.",
  keywords: ["steak & lobster combo","steak & lobster combo lewisville","hibachi lewisville","jinbeh steak & lobster combo","best hibachi lewisville","japanese restaurant lewisville","hibachi","teppanyaki","japanese steakhouse","hibachi grill"],
  openGraph: {
...
const faqSchema = {
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Absolutely! Steak & Lobster Combo is one of our most popular choices for birthdays, anniversaries, and celebrations. The interactive cooking show makes any meal memorable. Call (214) 618-9798 to reserve for your special event."
      }
    },
    {
      "@type": "Question",
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg mb-8">
                ...
                <div className="space-y-6">
                  ...
                  <details className="group border-b border-warm-ivory pb-4">
                    ...
                    <p className="mt-4 text-charcoal/70 leading-relaxed">
                      Absolutely! Steak & Lobster Combo is one of our most popular choices for birthdays, anniversaries, and celebrations. The interactive cooking show makes any meal memorable. Call (214) 618-9798 to reserve for your special event.
                    </p>
                  </details>
                  <details className="group border-b border-warm-ivory pb-4">
                    <summary className="flex justify-between items-center cursor-pointer list-none">
