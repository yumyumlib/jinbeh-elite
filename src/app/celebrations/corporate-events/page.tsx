...
export const metadata: Metadata = {
  ...
  description: "Host memorable corporate dinners, team building events & business celebrations at Jinbeh. Private hibachi tables, group sushi platters & professional service in Frisco &.",
  keywords: [
...
<section className="relative min-h-[60vh] flex items-center text-white py-20">
      ...
      <PageSeoBoost route="/celebrations/corporate-events" />
      <Footer />
    </>
  );
}
