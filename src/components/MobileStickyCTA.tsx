        ...
        >
            ...
            <div className="bg-charcoal py-4 px-6 pb-[max(1rem,env(safe-area-inset-bottom))] flex gap-3 shadow-lg shadow-black/20">
                ...
                <a
                    ...
                    aria-label="Call Jinbeh" className="flex items-center justify-center gap-2 px-4 py-4 bg-warm-ivory text-charcoal rounded-xl font-semibold hover:bg-white transition-colors"
                >
