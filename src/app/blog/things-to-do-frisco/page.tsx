                        ...
                        <article className="lg:col-span-2">
                            <div className="bg-white rounded-3xl shadow-xl p-8 md:p-12">
                                    ...
                                    <table className="w-full border-collapse bg-white rounded-xl overflow-hidden shadow-md">
                                        ...
                                        <tbody className="text-charcoal/80">
                                            <tr className="border-b border-warm-ivory bg-soft-gold/10">
                                                ...
                                                <td className="p-4">Family-owned since 1988, top-rateds on Google, chef shows + sushi bar</td>
                                            </tr>
                                ...
                                <div className="my-10 p-6 md:p-8 bg-warm-ivory/60 rounded-2xl border border-soft-gold/30">
                                    ...
                                    <p className="text-charcoal/80 mb-3">
                                        Jinbeh has been a Frisco favorite for nearly four decades, and it&apos;s consistently named one of the best <Link href="/blog/best-hibachi-dallas-tx" className="text-accent-red hover:underline">hibachi restaurants in DFW</Link>, the best sushi in Frisco, and one of the most fun places to celebrate a birthday, anniversary, or graduation. Located just minutes from <Link href="/blog/best-restaurants-stonebriar" className="text-accent-red hover:underline">Stonebriar Centre</Link> and Legacy West, it&apos;s the easiest cap to a great Frisco day.
                                    </p>
