...
export const metadata: Metadata = {
 title:
 "Watch Japan & World Soccer in DFW: Samurai Blue at Jinbeh Frisco | Japan's Table in Texas",
 description:
 "Watch the 2026 international soccer tournament at Jinbeh, DFW's family-owned Japanese restaurant since 1988, 3 miles from Toyota Stadium (Japan's base camp). Matches on our screens June 11 to July 19, hibachi and sushi at your table. Reserve in Frisco or Lewisville.",
 keywords: [
    "soccer watch party dfw",
    "where to watch soccer dallas",
    "japan brazil watch party dallas",
    "samurai blue dallas",
    "soccer watch party near att stadium",
 "japan 2026 soccer tournament dallas",
 "japan soccer watch party frisco",
 "where to watch japan play dallas",
 "samurai blue dallas",
 ...
 "match-day dinner reservation frisco",
 "2026 international soccer tournament dfw",
 "japan match schedule att stadium",
 "japan base camp toyota stadium frisco",
 "restaurants near dallas stadium",
 "where to watch near dallas stadium arlington",
 "where to watch the semifinal dallas",
 "semifinal watch party dfw",
 "july 14 semifinal watch party arlington",
 "round of 16 watch party dfw",
 "knockout watch party dallas",
 "restaurant with big screens to watch soccer dfw",
 "watch every match on the big screen dallas",
 "family friendly soccer watch party frisco",
 "kid friendly place to watch soccer dfw",
 "sports bar alternative for soccer frisco",
 "best place to watch the matches with family dfw",
 "soccer watch party plano allen mckinney",
 "where to watch soccer arlington",
 "donde ver el partido dallas",
 "donde ver futbol en frisco",
 "restaurante para ver los partidos dfw",
 "argentina watch party dallas",
 "brazil watch party dfw",
 "mexico watch party dallas",
 ],
 openGraph: {
 title: "Japan's Table in Texas: Watch Samurai Blue Soccer at Jinbeh",
 description:
 "Watch Samurai Blue at the 2026 international soccer tournament, June 11 to July 19. Three miles from Toyota Stadium, Japan's base camp. Reserve your table in Frisco or Lewisville.",
 ...
 width: 1200,
 height: 630,
 alt: "Jinbeh Japanese Restaurant — 2026 soccer tournament — Japan's Table in Texas",
 },
 ],
 type: "website",
 },
 ...
 title: "Soccer Watch Parties at Jinbeh | Frisco & Lewisville TX",
 description: "Catch every tournament match at Jinbeh. Japanese food, drinks, and the best atmosphere in DFW for the 2026 international soccer tournament.",
 },
 alternates: {
...
const faqs = [
 ...
 a: "Yes — Jinbeh Frisco is less than 3 miles from Toyota Stadium, the designated Japan base camp for the 2026 soccer tournament. We're at 2693 Preston Road in Frisco; the stadium is at 9200 World Cup Way.",
 },
 {
 q: "Where can I watch the japan soccer game in Frisco?",
 ...
 a: "Our Sashimi Combination ($42) — 15 pieces of premium sashimi (tuna, salmon, yellowtail), served with miso soup and house salad. Complimentary edamame is included during the tournament window (June 11 – July 19, 2026). Available dine-in at both locations.",
 },
 {
 q: "How far is Jinbeh from AT&T Stadium?",
 a: "Jinbeh Frisco is about a 45-minute drive north of AT&T Stadium in normal traffic, and Jinbeh Lewisville is about 35 minutes north. Both make ideal pre-match dinner or post-match celebration destinations.",
 },
 {
 q: "When are the tournament matches at AT&T Stadium?",
 a: "AT&T Stadium in Arlington hosts tournament matches throughout the tournament, June 11 through July 19, 2026. Check the official international soccer schedule for exact dates and kickoff times, then reserve your Jinbeh table for the days you want to watch.",
 },
 {
 q: "Does Jinbeh deliver during the tournament?",
 ...
 {
 q: "What restaurants will be busy during the tournament in Dallas?",
 ...
 {
 q: "Where is the Fan Festival in Dallas and where should I eat before going?",
 a: "Jinbeh is an easy pre-festival stop on your way to Fair Park, where the free Dallas Fan Festival runs June 11 through July 19 with giant screens, concerts, and food courts. Fair Park gets long, hot, and crowded, so start with a hibachi lunch or early dinner at Jinbeh Frisco or Lewisville first, or grab sushi platters and bento to take with you.",
 },
 {
 q: "Why watch the matches at Jinbeh instead of a sports bar?",
 ...
 {
 q: "Where can I watch the semifinal in DFW?",
 a: "One of the two global semifinals is being played at Dallas Stadium (AT&T Stadium) in Arlington on July 14. Jinbeh shows the semifinal and every knockout match on big screens at both Frisco and Lewisville, so you can pair the biggest match of the summer with hibachi and sushi. Reserve early, since semifinal day is one of the busiest of the tournament.",
 },
 {
 q: "Does Jinbeh show the matches on big screens?",
 a: "Yes. We carry every match on screens throughout the dining room and bar at both locations, from the Round of 32 and Round of 16 through the Dallas Stadium semifinal. It is an easy place to watch all the matches over hibachi and fresh sushi rather than typical bar food.",
 },
 {
 q: "Is Jinbeh a good family friendly place to watch soccer?",
 a: "Absolutely. Families have gathered at Jinbeh since 1988, and the tableside hibachi show keeps kids entertained while the grown-ups watch the match. If you are searching for a kid friendly place to watch the matches, a relaxed alternative to a crowded sports bar, or simply donde ver el partido in Frisco, Lewisville, or near Plano, Allen, and McKinney, we welcome the whole family.",
 },
];
...
const articleSchema = {
 ...
 "@type": "Article",
 headline:
 "Japan's Table in Texas: Watch Samurai Blue at the 2026 international soccer tournament",
 description:
 "Watch Japan at the 2026 international soccer tournament from DFW's Japanese restaurant — 3 miles from Toyota Stadium, the designated Japan base camp.",
...
export default function WorldCup2026Page() {
 ...
 alt="Japan 2026 soccer tournament Dallas at Jinbeh Japanese restaurant"
 fill
 ...
 🇯🇵 2026 international soccer tournament · June 11 – July 19
 </p>
 <h1 className="text-4xl md:text-5xl font-heading font-bold mb-6 leading-tight">
 Japan&apos;s Table in Texas: Watch Samurai Blue and World Soccer in DFW
 </h1>
 <p className="text-xl text-white/85 mb-6 leading-relaxed">
 The 2026 international soccer tournament is here, running June 11 through July 19,
 and it brings Japan to North Texas. Samurai Blue&apos;s national-team base camp is at Toyota Stadium in Frisco, less than 3 miles from
 ...
 {/* Upcoming Matches — refreshed schedule */}
                <section className="py-14 bg-charcoal text-white">
                    <div className="container mx-auto px-6 max-w-4xl">
                        <p className="text-soft-gold font-medium tracking-wider uppercase mb-2 text-sm text-center">
                            Next Up · Watch With Us · Frisco & Lewisville
                        </p>
                        <h2 className="text-3xl md:text-4xl font-heading font-bold mb-3 text-center">
                            Upcoming Matches at Jinbeh
                        </h2>
                        <p className="text-white/85 leading-relaxed max-w-2xl mx-auto mb-8 text-center">
                            Samurai Blue gave us an unforgettable run before bowing out in a
                            hard-fought knockout match against Brazil. The tournament now races
                            toward the Dallas Stadium semifinal in Arlington on July 14. Here are
                            the matches we are showing on every big screen at both locations.
                            Looking for a family friendly place to watch the matches, a more
                            relaxed alternative to a packed sports bar, or simply donde ver el
                            partido in DFW? Reserve early, because match days fill our dining
                            rooms fast.
                        </p>
                        <div className="bg-blue-800 rounded-2xl p-6 md:p-8 mb-6 text-center">
                            <span className="inline-block bg-soft-gold text-charcoal text-[10px] font-bold uppercase tracking-wider px-3 py-1 rounded-full mb-3">
                                ⭐ Featured · The Dallas Semifinal
                            </span>
                            <h3 className="text-2xl md:text-3xl font-heading font-bold mb-1">
                                Semifinal at Dallas Stadium
                            </h3>
                            <p className="text-soft-gold font-bold mb-1">Tuesday, July 14 · 2:00 PM CT · Dallas Stadium (AT&amp;T Stadium), Arlington</p>
                            <p className="text-white/85 text-sm max-w-xl mx-auto mb-5">
                                One of only two semifinals on the planet is happening right here in
                                North Texas. If you are searching where to watch the semifinal in
                                DFW, make it a watch party with the match on our big screens,
                                hibachi cooked at your table, and fresh sushi. Reserve a table in
                                Frisco or Lewisville before this one sells out.
                            </p>
                            <div className="flex flex-wrap gap-3 justify-center">
                                <ReserveLink href="https://www.opentable.com/booking/restref/availability?rid=188458&lang=en-US" className="inline-flex items-center gap-2 bg-soft-gold text-charcoal font-semibold px-5 py-2.5 rounded-full hover:bg-white transition">Reserve Frisco</ReserveLink>
                                <ReserveLink href="https://www.opentable.com/booking/restref/availability?rid=188461&lang=en-US" className="inline-flex items-center gap-2 bg-white/15 backdrop-blur text-white font-semibold px-5 py-2.5 rounded-full hover:bg-white/25 transition border border-white/30">Reserve Lewisville</ReserveLink>
                            </div>
                        </div>
                        <ul className="divide-y divide-white/10 bg-white/5 rounded-2xl overflow-hidden">
                            <li className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-1 px-5 py-3">
                                <span className="text-soft-gold font-bold text-sm">Tue, June 30 · 12:00 PM CT</span>
                                <span className="text-white/90">Knockout, Round of 32 · Dallas Stadium (AT&amp;T Stadium), Arlington</span>
                            </li>
                            <li className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-1 px-5 py-3">
                                <span className="text-soft-gold font-bold text-sm">Fri, July 3 · 1:00 PM CT</span>
                                <span className="text-white/90">Knockout, Round of 32 · Dallas Stadium (AT&amp;T Stadium), Arlington</span>
                            </li>
                            <li className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-1 px-5 py-3">
                                <span className="text-soft-gold font-bold text-sm">Mon, July 6 · 2:00 PM CT</span>
                                <span className="text-white/90">Round of 16 · Dallas Stadium (AT&amp;T Stadium), Arlington</span>
                            </li>
                            <li className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-1 px-5 py-3">
                                <span className="text-soft-gold font-bold text-sm">Tue, July 14 · 2:00 PM CT</span>
                                <span className="text-white/90">Semifinal · Dallas Stadium (AT&amp;T Stadium), Arlington</span>
                            </li>
                        </ul>
                        <p className="text-white/60 text-xs italic mt-4 text-center max-w-2xl mx-auto">
                            Times are Central and subject to change. Check the official tournament
                            schedule for confirmed kickoff times. We show every match through July 19.
                        </p>
                        <p className="text-center mt-5">
                            <Link href="/celebrations/world-cup-watch-party" className="text-soft-gold hover:text-white underline font-medium">
                                See our Japan watch party with pro soccer player Chioma Ubogagu →
                            </Link>
                        </p>
                    </div>
                </section>
 ...
 for the games you want to watch. Check the official international soccer schedule
 ...
 <h2 className="text-3xl md:text-4xl font-heading font-bold text-charcoal">
 Matches at AT&amp;T Stadium in Arlington
 </h2>
 ...
 Headed to the Fan Festival? Fuel Up at Jinbeh First
 </h2>
 <div className="space-y-4 text-white/90 leading-relaxed">
 <p>
 Dallas turns Fair Park into the official Fan Festival for all
 ...
 thing on our menu, featured throughout the tournament window.
 </p>
 </div>
 ...
 <p>
 When international soccer selected Toyota Stadium as Japan&apos;s official base
 ...
 <h2 className="text-3xl md:text-4xl font-heading font-bold text-charcoal mb-6">
 Best Japanese Restaurant Near AT&amp;T Stadium for tournament matches
 </h2>
 <div className="prose prose-lg max-w-none text-charcoal/85 space-y-4">
 <p>
 AT&amp;T Stadium in Arlington — the marquee North Texas venue
 for the 2026 tournament — is about a <strong>45-minute drive south of Jinbeh Frisco</strong> and a <strong>35-minute drive from Jinbeh Lewisville</strong>. The math: a 45-minute drive north for an
 ...
 Saturdays. Pre-purchase via the international soccer app. Ride-share queues
 ...
 2026 soccer tournament at Jinbeh — Common Questions
 </h2>
 ...
 Reserve Your Table for the tournament
 </h2>
 ...
 Questions? Call{" "}
 <CallLink href="tel:2146191200" className="text-soft-gold underline">
 (214) 619-1200
 </CallLink>{" "}
 (Frisco) or{" "}
 <CallLink href="tel:2144882224" className="text-soft-gold underline">
 (214) 488-2224
 </CallLink>{" "}
 (Lewisville).
 </p>
