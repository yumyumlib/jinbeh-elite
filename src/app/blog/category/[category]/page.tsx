...
const categories = {
  sushi: {
    ...
    articles: [
      ...
      { slug: "types-of-sushi", title: "Types of Sushi: Complete Guide", image: "/images/blog/17-C060324-6708.jpg", excerpt: "Nigiri, maki, temaki, and more — learn every sushi style." },
      { slug: "beginner-sushi-tips", title: "Sushi for Beginners", image: "/images/blog/22-C060324-6829.jpg", excerpt: "New to sushi? Start here for your first Japanese dining adventure." },
      { slug: "sashimi-vs-sushi", title: "Sashimi vs Sushi Explained", image: "/images/blog/17-C060324-6708.jpg", excerpt: "What's the difference? We break it down for you." },
      { slug: "how-to-eat-sushi-guide", title: "How to Eat Sushi Properly", image: "/images/blog/22-C060324-6829.jpg", excerpt: "Chopstick etiquette, soy sauce tips, and wasabi dos and don'ts." },
      { slug: "sushi-identification-chart", title: "Sushi Identification Chart", image: "/images/food/FreshSushiAndDessertsAtSushiBar.jpg", excerpt: "Visual guide to identifying sushi by type and ingredient." },
      { slug: "omakase-dining-guide", title: "Omakase Dining Guide", image: "/images/blog/17-C060324-6708.jpg", excerpt: "Trust the chef — how omakase creates a personalized sushi experience." },
  ...
  hibachi: {
    ...
    articles: [
      ...
      { slug: "hibachi-vs-teppanyaki-explained", title: "Hibachi vs Teppanyaki", image: "/images/photoshoot/hibachi-onion-volcano-flame.jpg", excerpt: "What's the real difference? It's more than just a name." },
      { slug: "discover-teppanyaki", title: "Discover Teppanyaki", image: "/images/photoshoot/hibachi-plate-shrimp.jpg", excerpt: "The history and art behind teppanyaki-style cooking." },
      { slug: "hibachi-dining-experience", title: "Hibachi Dining Experience", image: "/images/food/HibachiComboNYStripAndColossalShrimp.jpg", excerpt: "What to expect at your first hibachi dinner — from start to finish." },
      { slug: "hibachi-menu-guide", title: "Hibachi Menu Guide", image: "/images/photoshoot/hibachi-plate-shrimp.jpg", excerpt: "Navigate the hibachi menu like a pro — proteins, sides, and combos." },
      { slug: "hibachi-calories-guide", title: "Hibachi Calories Guide", image: "/images/food/HibachiComboNYStripAndColossalShrimp.jpg", excerpt: "Nutrition info for popular hibachi dishes and healthier options." },
      ...
      { slug: "hibachi-catering-dfw", title: "Hibachi Catering in DFW", image: "/images/photoshoot/hibachi-plate-shrimp.jpg", excerpt: "Bring the hibachi experience to your next event or party." },
    ],
    faq: [
  ...
  celebrations: {
    ...
    articles: [
      ...
      { slug: "birthday-celebration-restaurants", title: "Birthday Celebration Restaurants", image: "/images/celebrations/CelebrateYourBirthdayAtJinbeh.jpg", excerpt: "The best restaurants for birthday dinners in Frisco and DFW." },
      { slug: "free-birthday-food-deals", title: "Free Birthday Food Deals", image: "/images/celebrations/CelebrateYourBirthdayAtJinbeh.jpg", excerpt: "Where to score free meals on your birthday in North Texas." },
      { slug: "adult-birthday-party-ideas", title: "Adult Birthday Party Ideas", image: "/images/celebrations/CelebrateYourBirthdayAtJinbeh.jpg", excerpt: "Sophisticated birthday celebrations for grown-ups." },
      { slug: "unique-kids-birthday-party-places", title: "Unique Kids Birthday Venues", image: "/images/celebrations/CelebrateYourBirthdayAtJinbeh.jpg", excerpt: "Fun and memorable birthday venues kids will love." },
      ...
      { slug: "large-group-dining", title: "Large Group Dining", image: "/images/interior/JinbehFriscoTables.jpg", excerpt: "Tips for booking and enjoying a large group dinner." },
      { slug: "restaurants-private-rooms", title: "Private Dining Rooms", image: "/images/interior/JinbehFriscoTables.jpg", excerpt: "Restaurants with private rooms for special occasions." },
    ],
    faq: [
  ...
  "happy-hour": {
    ...
    articles: [
      ...
      { slug: "types-of-sake-explained", title: "Types of Sake Explained", image: "/images/drinks/cocktail.jpg", excerpt: "Junmai, Daiginjo, Nigori — what's the difference?" },
      { slug: "sake-taste-profile", title: "Sake Taste Profile", image: "/images/drinks/cocktail.jpg", excerpt: "Sweet, dry, fruity, earthy — find your ideal sake flavor." },
      { slug: "sake-alcohol-strength", title: "Sake Alcohol Strength", image: "/images/drinks/cocktail.jpg", excerpt: "How strong is sake compared to wine and beer?" },
      ...
      { slug: "japanese-whiskey-guide", title: "Japanese Whiskey Guide", image: "/images/drinks/cocktail.jpg", excerpt: "Why Japanese whiskey is taking the world by storm." },
      { slug: "yamazaki-whiskey-guide", title: "Yamazaki Whiskey Guide", image: "/images/drinks/cocktail.jpg", excerpt: "Everything you need to know about Suntory Yamazaki." },
      { slug: "ramune-soda-guide", title: "Ramune Soda Guide", image: "/images/drinks/MangoTangoDrinks.png", excerpt: "The iconic marble-sealed Japanese soda — flavors and history." },
    ],
    faq: [
  ...
  "local-guide": {
    ...
    articles: [
      ...
      { slug: "japanese-restaurants-near-me", title: "Japanese Restaurants Near Me", image: "/images/exterior/JinbehFriscoStorefrontSign.jpg", excerpt: "Find the best Japanese restaurants in your area." },
      { slug: "japanese-restaurants-lewisville", title: "Japanese Restaurants in Lewisville", image: "/images/exterior/JinbehFriscoStorefrontSign.jpg", excerpt: "Lewisville's top Japanese dining destinations." },
      ...
      { slug: "asian-cuisine-dallas", title: "Asian Cuisine in Dallas", image: "/images/food/FreshSushiAndDessertsAtSushiBar.jpg", excerpt: "Exploring Dallas's diverse Asian food scene." },
      { slug: "best-asian-food-dallas", title: "Best Asian Food in Dallas", image: "/images/food/FreshSushiAndDessertsAtSushiBar.jpg", excerpt: "Top-rated Asian restaurants across the Dallas metro." },
      { slug: "best-seafood-dallas", title: "Best Seafood in Dallas", image: "/images/blog/17-C060324-6708.jpg", excerpt: "Where to find the freshest seafood in DFW." },
      { slug: "best-steak-near-me", title: "Best Steak Near Me", image: "/images/food/HibachiComboNYStripAndColossalShrimp.jpg", excerpt: "Premium steak options including hibachi NY strip and filet." },
    ],
    faq: [
  ...
  beverages: {
    ...
    articles: [
      ...
      { slug: "types-of-sake-explained", title: "Types of Sake Explained", image: "/images/drinks/cocktail.jpg", excerpt: "Junmai, Daiginjo, Nigori — learn the sake family." },
      { slug: "sake-taste-profile", title: "Sake Taste Profile", image: "/images/drinks/cocktail.jpg", excerpt: "Find your perfect sake: dry, sweet, fruity, or rich." },
      { slug: "sake-alcohol-strength", title: "Sake Alcohol Strength", image: "/images/drinks/cocktail.jpg", excerpt: "How strong is sake compared to wine, beer, and spirits?" },
      ...
      { slug: "japanese-whiskey-guide", title: "Japanese Whiskey Guide", image: "/images/drinks/cocktail.jpg", excerpt: "Why the world is obsessed with Japanese whiskey." },
      { slug: "yamazaki-whiskey-guide", title: "Yamazaki Whiskey Guide", image: "/images/drinks/cocktail.jpg", excerpt: "Deep dive into Suntory's legendary Yamazaki single malt." },
      { slug: "ramune-soda-guide", title: "Ramune Soda Guide", image: "/images/drinks/MangoTangoDrinks.png", excerpt: "The iconic marble-sealed Japanese soda — flavors and how to open it." },
    ],
    faq: [
  ...
  cuisine: {
    ...
    articles: [
      ...
      { slug: "sashimi-vs-sushi", title: "Sashimi vs Sushi Explained", image: "/images/blog/17-C060324-6708.jpg", excerpt: "What's the real difference between sashimi and sushi?" },
      { slug: "how-to-eat-sushi-guide", title: "How to Eat Sushi Properly", image: "/images/blog/22-C060324-6829.jpg", excerpt: "Etiquette, chopstick tips, and wasabi guidelines." },
      { slug: "hibachi-vs-teppanyaki-explained", title: "Hibachi vs Teppanyaki", image: "/images/photoshoot/hibachi-onion-volcano-flame.jpg", excerpt: "The surprising difference between these two cooking styles." },
      { slug: "discover-teppanyaki", title: "Discover Teppanyaki", image: "/images/photoshoot/hibachi-plate-shrimp.jpg", excerpt: "The history and art of Japanese teppanyaki cooking." },
      { slug: "omakase-dining-guide", title: "Omakase Dining Guide", image: "/images/blog/17-C060324-6708.jpg", excerpt: "'Trust the chef' — the art of omakase dining." },
      ...
      { slug: "sushi-identification-chart", title: "Sushi Identification Chart", image: "/images/food/FreshSushiAndDessertsAtSushiBar.jpg", excerpt: "Visual guide to identifying sushi by type." },
      { slug: "popular-japanese-culture", title: "Popular Japanese Culture", image: "/images/blog/17-C060324-6708.jpg", excerpt: "How Japanese food culture shapes the dining experience." },
      { slug: "asian-cuisine-dallas", title: "Asian Cuisine in Dallas", image: "/images/food/FreshSushiAndDessertsAtSushiBar.jpg", excerpt: "Exploring the diverse Asian food scene in Dallas." },
    ],
    faq: [
  ...
  health: {
    ...
    articles: [
      { slug: "hibachi-calories-guide", title: "Hibachi Calories Guide", image: "/images/food/HibachiComboNYStripAndColossalShrimp.jpg", excerpt: "Calorie counts for popular hibachi dishes and healthier swaps." },
      ...
      { slug: "sashimi-vs-sushi", title: "Sashimi vs Sushi Explained", image: "/images/blog/17-C060324-6708.jpg", excerpt: "Which is healthier? Comparing nutrition of sashimi and sushi." },
  ...
  "local-guides": {
    ...
    articles: [
      ...
      { slug: "japanese-restaurants-lewisville", title: "Japanese Restaurants in Lewisville", image: "/images/exterior/JinbehFriscoStorefrontSign.jpg", excerpt: "Best Japanese dining options in Lewisville." },
      { slug: "japanese-restaurants-near-me", title: "Japanese Restaurants Near Me", image: "/images/exterior/JinbehFriscoStorefrontSign.jpg", excerpt: "Find highly-rated Japanese restaurants in your area." },
      ...
      { slug: "pickleball-restaurants-lewisville", title: "Restaurants Near Pickleball in Lewisville", image: "/images/exterior/JinbehFriscoStorefrontSign.jpg", excerpt: "Where to eat after pickleball in Lewisville." },
      { slug: "seafood-lewisville", title: "Seafood in Lewisville", image: "/images/blog/17-C060324-6708.jpg", excerpt: "Fresh seafood and sushi options in Lewisville." },
    ],
    faq: [
