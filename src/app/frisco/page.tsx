          ...
          <div className="container mx-auto px-6">
            <div className="flex flex-wrap justify-center items-center gap-6 md:gap-10">
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  <p className="font-semibold text-charcoal text-sm">4.7 Google <span className="text-charcoal/50 font-normal">(200+ reviews)</span></p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  <p className="font-semibold text-charcoal text-sm">4.7 Grubhub <span className="text-charcoal/50 font-normal">(231+ reviews)</span></p>
                </div>
              </div>
