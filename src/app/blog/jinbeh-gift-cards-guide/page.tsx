  ...
  return (
    ...
    >
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"Where to Purchase","acceptedAnswer":{"@type":"Answer","text":"Jinbeh gift cards are available through multiple convenient options:"}},{"@type":"Question","name":"How Birthday Club Works","acceptedAnswer":{"@type":"Answer","text":"Enrollment: Sign up for the Birthday Club at any Jinbeh location or online. Provide your name and birthday."}},{"@type":"Question","name":"Why Join?","acceptedAnswer":{"@type":"Answer","text":"Call to Join: Reach out to either Jinbeh location to enroll in the Birthday Club."}},{"@type":"Question","name":"Why Jinbeh Gift Cards Make Great Gifts","acceptedAnswer":{"@type":"Answer","text":"For Immediate Gift Delivery: Purchase online and have digital card emailed the same day"}}]}) }}
      />
      <script
          type="application/ld+json"
      ...
      <p>
        A Jinbeh gift card is more than just payment for a meal. It's a passport to unforgettable dining experiences. Whether you received one as a gift, purchased it for someone special, or earned rewards, maximizing its value means knowing all the ways to enhance your Jinbeh experience.
              ...
              <div className="my-8 p-6 bg-gradient-to-r from-amber-50 to-yellow-50 rounded-xl border border-amber-200">
                ...
                <p className="text-charcoal/70 text-sm leading-relaxed">
                  A Jinbeh gift card isn&apos;t just dinner &mdash; it&apos;s an experience at a D Magazine &ldquo;Best of Big D&rdquo; winner with 12+ current OpenTable Diners&apos; Choice and &ldquo;Best Of&rdquo; recognitions. Your recipient will enjoy the same award-winning hibachi and sushi that food critics and thousands of diners have celebrated for 38 years.
                </p>
              </div>
              </div>
