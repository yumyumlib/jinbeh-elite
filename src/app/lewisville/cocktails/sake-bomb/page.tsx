...
export const metadata: Metadata = {
  ...
  description: "Classic sake dropped into cold beer Enjoy Sake Bomb at Jinbeh Japanese Restaurant in Lewisville, TX. Easy access from I-35E, near Vista Ridge Mall. Call (214) 488-2224 to reserve.",
    ...
    <>
      ...
      <main className="min-h-screen bg-warm-ivory">
        ...
        <section className="relative py-16 text-white overflow-hidden">
          <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: "url('/images/catalog/11-C060324-6544.jpg')" }} />
