    ...
    return (
        <main id="main-content" className="min-h-screen bg-warm-ivory">
            ...
            <section className="relative h-[55vh] min-h-[460px] flex items-end overflow-hidden">
                <Image src="/images/hibachi-lewisville-2026/jinbeh-japanese-restaurant-interior-lewisville-002-orig-IMG_1830-1200w.webp" alt="Japanese restaurants Lewisville TX — Jinbeh interior with hibachi tables and sushi bar" fill className="object-cover" priority sizes="100vw" />
