...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "sushi restaurants vista ridge",
    "teppanyaki near vista ridge mall",
    "best japanese food vista ridge",
    "japanese dining vista ridge",
    "hibachi restaurant lewisville",
    "sushi near i-35e lewisville",
  ],
  openGraph: {
...
// Local Business Schema for Lewisville Location
...
const faqSchema = {
  ...
  mainEntity: [
    {
      "@type": "Question",
      name: "How far is Jinbeh from Vista Ridge Mall?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Jinbeh Lewisville is conveniently located just minutes from Vista Ridge Mall on I-35E. Our location near the Vista Ridge area makes it easy to stop by for dinner before or after shopping, with ample parking available.",
      },
    },
    {
      "@type": "Question",
      name: "Is there parking near Jinbeh Lewisville?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Yes! Jinbeh Lewisville has convenient free parking in the strip mall lot. Plenty of parking spaces available for all our guests, making it easy to visit us near Vista Ridge.",
      },
    },
    {
      "@type": "Question",
...
const nearbyAttractions = [
  {
    ...
    description: "Premier shopping destination with 100+ retailers and dining",
  },
  {
    name: "Castle Hills",
    distance: "8 min drive",
    description: "Upscale residential community with parks and amenities",
  },
  {
    name: "Lake Lewisville",
    distance: "10 min drive",
    description: "Beautiful lake for fishing, boating, and water activities",
  },
  {
    name: "Toyota of Lewisville Railroad Park",
    distance: "5 min drive",
    description: "Family-friendly park with playground and outdoor activities",
  },
];

export default function VistaRidgePage() {
  return (
    <>
      ...
      <main className="min-h-screen">
        ...
        <section className="relative h-[50vh] min-h-[400px] flex items-center justify-center overflow-hidden">
          <div
            ...
            style={{ backgroundImage: "url('/images/lewisville/IMG_1910.jpg')" }}
          />
          <div className="absolute inset-0 bg-gradient-to-b from-black/60 via-black/40 to-black/70" />
          <div className="relative z-10 text-center text-white px-6 max-w-4xl mx-auto">
            <p className="text-soft-gold font-medium tracking-wider uppercase mb-4">
              Just Minutes from Vista Ridge Mall
            </p>
            ...
            <p className="text-xl text-warm-ivory/90 max-w-2xl mx-auto mb-8">
              ...
              your perfect dining destination in the Vista Ridge area!
            </p>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div>
                  <h2 className="text-3xl md:text-4xl font-heading font-bold text-charcoal mb-6">
                    The Best Hibachi & Sushi Near Vista Ridge
                  </h2>
                  ...
                  <ul className="space-y-4 mb-8">
                    ...
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        <span className="font-semibold text-charcoal">Easy Access & Parking</span>
                        <p className="text-charcoal/70 text-sm">Convenient location off I-35E with ample free parking</p>
                      </div>
                    </li>
                  </ul>
                  <Link
          ...
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto text-center mb-12">
              <h2 className="text-3xl font-heading font-bold text-charcoal mb-4">
                Conveniently Located Near Vista Ridge&apos;s Best Attractions
              </h2>
              <p className="text-lg text-charcoal/70">
                Jinbeh Lewisville is perfectly positioned near the Vista Ridge area and beyond
              </p>
            </div>
        ...
        <section className="py-16 bg-gradient-to-br from-accent-red to-deep-indigo text-white">
          <div className="container mx-auto px-6 text-center">
            ...
            <p className="text-xl text-white/90 max-w-2xl mx-auto mb-10">
              Reserve your table at Jinbeh Lewisville today. Just minutes from Vista Ridge Mall!
            </p>
