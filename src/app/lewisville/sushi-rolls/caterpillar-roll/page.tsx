...
export const metadata: Metadata = {
  ...
  description: "Caterpillar Roll at Jinbeh Lewisville: Grilled eel, cucumber, avocado topping, sesame. Premium sushi near I-35E. Call (214) 488-2224.",
...
const faqSchema = {
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes! Caterpillar Roll is available for takeout and delivery. For the best presentation and taste, we recommend dining in at our sushi bar. Call (214) 488-2224 to order."
      }
    }
  ]
};
