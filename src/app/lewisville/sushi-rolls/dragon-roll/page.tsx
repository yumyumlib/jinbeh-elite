...
const faqSchema = {
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes! Dragon Roll is available for takeout. Call (214) 488-2224 to order. For the freshest experience, we recommend dining at our sushi bar where you can watch our chefs prepare your roll to order."
      }
    }
  ]
};
