    ...
    <>
      ...
      <main className="min-h-screen bg-warm-ivory">
        ...
        <section className="relative py-16 text-white overflow-hidden">
          <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: "url('/images/food/alaskan-roll.jpg')" }} />
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg mb-8">
                ...
                <div className="space-y-6">
                  ...
                  <details className="group border-b border-warm-ivory pb-4">
                    ...
                    <p className="mt-4 text-charcoal/70 leading-relaxed">
                      Yes! Philadelphia Roll is available for takeout and delivery. For the freshest experience, we recommend dining in at our sushi bar. Call (214) 619-1200 to order.
                    </p>
                  </details>
                  <details className="group border-b border-warm-ivory pb-4">
                    <summary className="flex justify-between items-center cursor-pointer list-none">
