...
export const metadata: Metadata = {
  ...
  description: "Spicy Tuna Roll at Jinbeh Lewisville: Fresh tuna, spicy mayo, 260-350 cal. Premium sushi near I-35E. Made fresh to order. Call (214) 488-2224.",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Jinbeh Japanese Restaurant — Lewisville Sushi Rolls Spicy Tuna Roll",
      },
    ],
  },
  alternates: {
  ...
  return (
    <>
      ...
      <div className="container mx-auto max-w-6xl px-4 lg:px-6">
        <BreadcrumbNav items={[{ label: "Lewisville", href: "/lewisville" }, { label: "Sushi Rolls", href: "/lewisville/sushi-rolls" }, { label: "Spicy Tuna Roll" }]} />
      </div>
      <div>
