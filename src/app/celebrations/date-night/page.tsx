...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Yes, we recommend reservations, especially for Friday and Saturday evenings. Call Frisco at (214) 619-1200 or Lewisville at (214) 488-2224, or book online through OpenTable.",
      },
    },
    {
      "@type": "Question",
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Date Night" },
  ],
};
export default function DateNightPage() {
  return (
    <>
      ...
      <div className="container mx-auto max-w-6xl px-4 lg:px-6">
        <BreadcrumbNav items={[{ label: "Celebrations", href: "/celebrations" }, { label: "Date Night" }]} />
      </div>
 ...
 Japanese draft beer, sake, and wine, Mon–Fri 5:00 to 6:30 PM,                     are the perfect way to kick things off.
      ...
      <PageSeoBoost route="/celebrations/date-night" />
      <Footer />
    </>
  );
}
