...
export const metadata: Metadata = {
  ...
  description: "Celebrate your anniversary with an unforgettable hibachi dinner at Jinbeh. Romantic atmosphere, exceptional Japanese cuisine, and tableside entertainment in Frisco and.",
  keywords: [
...
<section className="relative h-[60vh] min-h-[500px] flex items-center justify-center overflow-hidden">
      ...
      <PageSeoBoost route="/celebrations/anniversary" />
      <Footer />
    </>
  );
}
