...
export const metadata: Metadata = {
  ...
  description: "Jinbeh Frisco's hibachi menu — 14 teppanyaki entrées with tableside fire shows, onion volcano, and premium cuts. Near Stonebriar Centre. Family-owned since 1988.",
...
const faqSchema = {
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Guest favorites include Filet Mignon, NY Strip Steak, Ribeye Steak, Chicken Teriyaki. These are consistently rated as the best hibachi in Frisco."
      }
    },
    {
      "@type": "Question",
