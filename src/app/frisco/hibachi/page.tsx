...
export const metadata: Metadata = {
  ...
  description: "Jinbeh Frisco's hibachi menu — 14 teppanyaki entrées with tableside fire shows, onion volcano, and premium cuts. Near Stonebriar Centre. Family-owned.",
