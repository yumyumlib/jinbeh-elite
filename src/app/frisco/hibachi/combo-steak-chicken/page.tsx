...
export const metadata: Metadata = {
  ...
  description: "Filet mignon with chicken teriyaki Enjoy Steak & Chicken Combo at Jinbeh Japanese Restaurant in Frisco, TX. Near Stonebriar Centre, minutes from Legacy West. Call (214) 618-9888 to reserve.",
...
const faqSchema = {
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Absolutely! Steak & Chicken Combo is one of our most popular choices for birthdays, anniversaries, and celebrations. The interactive cooking show makes any meal memorable. Call (214) 618-9888 to reserve for your special event."
      }
    },
    {
      "@type": "Question",
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg mb-8">
                ...
                <p className="text-charcoal/80 leading-relaxed mb-6">
                  Experience the exceptional Steak & Chicken Combo at Jinbeh Frisco.
                ...
                <div className="space-y-6">
                  <details className="group border-b border-warm-ivory pb-4">
                    <summary className="flex justify-between items-center cursor-pointer list-none">
                      <h3 className="font-medium text-charcoal pr-4">What is Steak & Chicken Combo hibachi at Jinbeh Frisco?</h3>
                    ...
                    <p className="mt-4 text-charcoal/70 leading-relaxed">
                      Steak & Chicken Combo at Jinbeh Frisco is filet mignon with chicken teriyaki. It\'s prepared tableside by our expert teppanyaki chefs with the famous onion volcano and entertaining knife skills. Priced at \$36.95, it includes soup, salad, fried rice, and grilled vegetables.
                    </p>
                  </details>
                  <details className="group border-b border-warm-ivory pb-4">
                    <summary className="flex justify-between items-center cursor-pointer list-none">
                  ...
                  <details className="group border-b border-warm-ivory pb-4">
                    ...
                    <p className="mt-4 text-charcoal/70 leading-relaxed">
                      Absolutely! Steak & Chicken Combo is one of our most popular choices for birthdays, anniversaries, and celebrations. The interactive cooking show makes any meal memorable. Call (214) 618-9888 to reserve for your special event.
                    </p>
                  </details>
                  <details className="group border-b border-warm-ivory pb-4">
                    <summary className="flex justify-between items-center cursor-pointer list-none">
                    ...
                    <p className="mt-4 text-charcoal/70 leading-relaxed">
                      Yes! Jinbeh Frisco specializes in group dining. Our hibachi tables seat 8-10 guests, perfect for sharing the Steak & Chicken Combo experience together. Near Stonebriar Centre, minutes from Legacy West.
                    </p>
                  </details>
                </div>
              </div>
