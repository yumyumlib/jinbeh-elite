  ...
  return (
    ...
    >
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"Why Hibachi Works for Birthdays","acceptedAnswer":{"@type":"Answer","text":"Most restaurants offer food. Hibachi offers an experience. When you book a birthday at a hibachi restaurant, you are not just choosing a menu, you are choosing entertainment that brings everyone together."}},{"@type":"Question","name":"What to Order at a Hibachi Birthday","acceptedAnswer":{"@type":"Answer","text":"Hibachi menus can feel overwhelming if you have never been. Here is what sells most for birthday parties:"}},{"@type":"Question","name":"Common Hibachi Birthday Mistakes (And How to Avoid Them)","acceptedAnswer":{"@type":"Answer","text":"A few people might not make it. Then everyone shows up, and you are scrambling. Book for your actual headcount. It is easier to release seats than add them."}}]}) }}
      />
      <script
          type="application/ld+json"
        ...
        Hibachi Birthday Party Ideas: Ultimate Planning Gu
            ...
            <div className="relative w-full aspect-[16/9] rounded-xl overflow-hidden my-8">
              <Image
                ...
                alt="Hibachi Birthday Party at Jinbeh Japanese restaurant"
                fill
