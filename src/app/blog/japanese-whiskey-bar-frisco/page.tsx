    ...
    return (
        <main id="main-content" className="min-h-screen bg-warm-ivory">
            ...
            <section className="relative h-[55vh] min-h-[460px] flex items-end overflow-hidden">
                <Image src="/images/drinks/JinbehPunchBeverageDrink.jpg" alt="Japanese whiskey at Jinbeh Frisco — bar program with whiskey, sake, craft cocktails" fill className="object-cover" priority sizes="100vw" />
