  ...
  return (
    <>
      ...
      <footer className="bg-charcoal text-warm-ivory">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8">
            ...
            <div className="lg:col-span-4">
              ...
              <a
                ...
                aria-label="Call Jinbeh Frisco" className="inline-flex items-center gap-2 text-warm-ivory hover:text-soft-gold transition-colors text-sm font-medium"
              >
            ...
            <div className="lg:col-span-4">
              ...
              <a
                ...
                aria-label="Call Jinbeh Lewisville" className="inline-flex items-center gap-2 text-warm-ivory hover:text-soft-gold transition-colors text-sm font-medium"
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
        ...
        {/* Bottom Bar - Appended pb-28 spacing avoids Mobile Sticky CTA overlay */}
        <div className="border-t border-warm-ivory/10 bg-charcoal/50 pb-28 lg:pb-0">
