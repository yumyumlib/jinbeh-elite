    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Jinbeh Japanese Restaurant — Frisco Sushi Rolls Volcano Roll",
      },
    ],
  },
  alternates: {
  ...
  return (
    <>
      ...
      <div className="container mx-auto max-w-6xl px-4 lg:px-6">
        <BreadcrumbNav items={[{ label: "Frisco", href: "/frisco" }, { label: "Sushi Rolls", href: "/frisco/sushi-rolls" }, { label: "Volcano Roll" }]} />
      </div>
      <div>
      ...
      <PageSeoBoost route="/frisco/sushi-rolls/volcano-roll" />
      <Footer />
    </>
  );
}
