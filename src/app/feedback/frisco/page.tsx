...
export const metadata: Metadata = {
  title: {
    absolute: "Share Your Feedback — Jinbeh Frisco | Japanese Restaurant",
  },
  description:
    "Tell us about your experience at Jinbeh Japanese Restaurant in Frisco, TX. Your feedback helps us serve you better. Hibachi, sushi, and more since 1988.",
  alternates: {
    canonical: "https://jinbeh.com/feedback/frisco",
  },
  robots: { index: false, follow: true },
};

export default function FriscoFeedbackPage() {
  return (
        ...
        <div className="container mx-auto px-6 text-center">
          <RevealSection>
            <h1 className="text-3xl md:text-5xl font-heading font-bold mb-4">
              How Was Your Visit to Jinbeh Frisco?
            </h1>
        ...
        <div className="container mx-auto px-6 text-center">
          <RevealSection>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              >
                <span>📞</span> Call Frisco: (214) 619-1200
              </a>
              <Link
                href="/contact"
