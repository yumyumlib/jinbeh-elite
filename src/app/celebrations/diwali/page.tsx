...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "We recommend making reservations for Diwali celebrations, especially for larger family groups. Call Frisco at (214) 618-9888 or Lewisville at (214) 618-9798.",
      },
    },
    {
      "@type": "Question",
