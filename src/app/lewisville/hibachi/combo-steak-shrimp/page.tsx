...
export const metadata: Metadata = {
  title: "Steak & Shrimp Combo | Jinbeh Lewisville Hibachi Menu",
  description: "Filet mignon paired with jumbo shrimp Enjoy Steak & Shrimp Combo at Jinbeh Japanese Restaurant in Lewisville, TX. Easy access from I-35E, near Vista Ridge Mall. Call (214) 488-2224 to reserve.",
  keywords: ["steak & shrimp combo","steak & shrimp combo lewisville","hibachi lewisville","jinbeh steak & shrimp combo","best hibachi lewisville","japanese restaurant lewisville","hibachi","teppanyaki","japanese steakhouse","hibachi grill"],
  openGraph: {
...
const faqSchema = {
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Absolutely! Steak & Shrimp Combo is one of our most popular choices for birthdays, anniversaries, and celebrations. The interactive cooking show makes any meal memorable. Call (214) 488-2224 to reserve for your special event."
      }
    },
    {
      "@type": "Question",
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg mb-8">
                ...
                <p className="text-charcoal/80 leading-relaxed mb-6">
                  Experience the exceptional Steak & Shrimp Combo at Jinbeh Lewisville.
                ...
                <div className="space-y-6">
                  <details className="group border-b border-warm-ivory pb-4">
                    <summary className="flex justify-between items-center cursor-pointer list-none">
                      <h3 className="font-medium text-charcoal pr-4">What is Steak & Shrimp Combo hibachi at Jinbeh Lewisville?</h3>
                    ...
                    <p className="mt-4 text-charcoal/70 leading-relaxed">
                      Steak & Shrimp Combo at Jinbeh Lewisville is filet mignon paired with jumbo shrimp. It\'s prepared tableside by our expert teppanyaki chefs with the famous onion volcano and entertaining knife skills. Priced at \$38.95, it includes soup, salad, fried rice, and grilled vegetables.
                    </p>
                  </details>
                  <details className="group border-b border-warm-ivory pb-4">
                    <summary className="flex justify-between items-center cursor-pointer list-none">
                  ...
                  <details className="group border-b border-warm-ivory pb-4">
                    ...
                    <p className="mt-4 text-charcoal/70 leading-relaxed">
                      Absolutely! Steak & Shrimp Combo is one of our most popular choices for birthdays, anniversaries, and celebrations. The interactive cooking show makes any meal memorable. Call (214) 488-2224 to reserve for your special event.
                    </p>
                  </details>
                  <details className="group border-b border-warm-ivory pb-4">
                    <summary className="flex justify-between items-center cursor-pointer list-none">
                    ...
                    <p className="mt-4 text-charcoal/70 leading-relaxed">
                      Yes! Jinbeh Lewisville specializes in group dining. Our hibachi tables seat 8-10 guests, perfect for sharing the Steak & Shrimp Combo experience together. Easy access from I-35E, near Vista Ridge Mall.
                    </p>
                  </details>
                </div>
              </div>
