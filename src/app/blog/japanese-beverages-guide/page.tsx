    ...
    return (
        ...
        />
            ...
            <section className="relative h-[50vh] min-h-[400px] flex items-end overflow-hidden">
                <Image src="/images/beverages/LewisvilleBar.jpg" alt="Premium sake bottles and Japanese spirits at the Jinbeh Lewisville bar" fill className="object-cover" priority />
