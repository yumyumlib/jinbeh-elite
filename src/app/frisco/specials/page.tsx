...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "frisco deals",
    "happy hour frisco",
    "lunch specials frisco",
    "japanese restaurant specials frisco",
    "sushi deals frisco",
    "hibachi specials",
  ],
  openGraph: {
  ...
  alternates: {
    canonical: "https://jinbeh.com/frisco/specials",
  },
};
...
export default function FriscoSpecialsPage() {
  return (
    <>
      <Header />
      <main className="min-h-screen">
        ...
        <section className="relative h-[50vh] min-h-[400px] flex items-center justify-center overflow-hidden">
          <div
            ...
            style={{ backgroundImage: "url('/images/photoshoot/hibachi-chicken.jpg')" }}
          />
          ...
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
              <div>
                ...
                <p className="text-lg font-bold">{frisco.address.street} {frisco.address.suite}</p>
              </div>
              <div>
                <p className="text-sm uppercase tracking-wider opacity-90">Phone</p>
                <p className="text-lg font-bold">{frisco.phone}</p>
              </div>
              <div>
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-6">
            ...
            <div className="text-center mt-12">
              ...
              <a href={`tel:${frisco.phoneClean}`} className="inline-block btn bg-charcoal text-white hover:bg-charcoal/90 px-8 py-4 rounded-xl font-bold text-lg transition-colors">
                {frisco.phone}
              </a>
            </div>
          </div>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="text-center">
                <p className="text-white/90 mb-6">
                  Don't miss Frisco's happy hour! Join us at the bar and enjoy great drinks, great food, and great company.
                </p>
                <a href={`tel:${frisco.phoneClean}`} className="inline-block btn bg-white text-accent-red hover:bg-warm-ivory px-8 py-4 rounded-xl font-bold text-lg transition-colors">
                  Reserve Bar Seating
                </a>
              </div>
            </div>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="text-center">
                ...
                <p className="text-charcoal/70">
                  Call {frisco.phone} to place your lunch order in advance
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl md:text-4xl font-heading font-bold text-charcoal mb-12 text-center">
                Why Dine at Jinbeh Frisco?
              </h2>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {[
                  { emoji: "📍", title: "Prime Location", desc: "Near Stonebriar Centre, easy access and convenient parking" },
                  { emoji: "🎊", title: "Lively Atmosphere", desc: "Modern Japanese ambiance with entertaining hibachi shows" },
                  { emoji: "👨‍🍳", title: "Expert Chefs", desc: "Talented sushi chefs and hibachi performers" },
                  { emoji: "🏆", title: "Award Quality", desc: "Consistently excellent ratings and reviews" },
                  { emoji: "👥", title: "Community Favorite", desc: "Popular with locals and visitors alike" },
                  { emoji: "📦", title: "Full Services", desc: "Dine-in, takeout, catering, and private events" },
                ].map((item, idx) => (
                  <div
                    key={idx}
              ...
              <div>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <a href={`tel:${frisco.phoneClean}`} className="text-white/80 hover:text-soft-gold transition-colors">
                      {frisco.phone}
                    </a>
                  </div>
                  <div>
                    <p className="text-soft-gold font-bold mb-1">Website</p>
                    <a href="/frisco" className="text-white/80 hover:text-soft-gold transition-colors">
