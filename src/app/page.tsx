                ...
                <div className="group bg-white/5 backdrop-blur-sm rounded-3xl overflow-hidden border border-white/10 hover:border-soft-gold/40 transition-all duration-500 h-full flex flex-col">
                  ...
                  <div className="p-6 flex-1 flex flex-col">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="mt-4 flex items-center justify-center gap-2 rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 px-4 py-3 text-sm text-white/70 hover:text-soft-gold transition-all"
                    >
