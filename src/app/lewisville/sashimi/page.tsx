...
const faqSchema = {
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Guest favorites include Salmon Sashimi, Tuna Sashimi, Yellowtail Sashimi, Octopus Sashimi. These are consistently rated as the best sashimi in Lewisville."
      }
    },
    {
      "@type": "Question",
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg space-y-6">
                ...
                <details className="group border-b border-warm-ivory pb-4">
                  ...
                  <p className="mt-4 text-charcoal/70 leading-relaxed">
                    Guest favorites include Salmon Sashimi, Tuna Sashimi, Yellowtail Sashimi, Octopus Sashimi. These are consistently rated as the best sashimi in Lewisville.
                  </p>
                </details>
                <details className="group border-b border-warm-ivory pb-4">
                  <summary className="flex justify-between items-center cursor-pointer list-none">
...
Pricing is listed on our current menu. Browse the full menu for details.
        ...
        <CategoryLocationSEO locationId="lewisville" category="sashimi" />
