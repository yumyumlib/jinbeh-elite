...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Absolutely! Mother's Day is our busiest day of the year. Call Frisco at (214) 619-1200 or Lewisville at (214) 488-2224 at least 1-2 weeks in advance to secure your table.",
      },
    },
    {
      "@type": "Question",
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Mothers Day" },
  ],
};
  ...
  return (
    <>
      ...
      <div className="container mx-auto max-w-6xl px-4 lg:px-6">
        <BreadcrumbNav items={[{ label: "Celebrations", href: "/celebrations" }, { label: "Mothers Day" }]} />
      </div>
...
<section className="relative h-[70vh] min-h-[500px] flex items-center justify-center overflow-hidden">
          ...
          <Image
            ...
            alt="Mothers Day Dinner Frisco at Jinbeh Japanese restaurant's Day sushi dinner celebration at Jinbeh"
            fill
              ...
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div>
                  ...
                  <ul className="space-y-3 text-white/90">
                    ...
                    <li className="flex items-center gap-3">
                      <span className="text-deep-indigo bg-white rounded-full w-5 h-5 flex items-center justify-center text-xs">★</span>
                      Sunrise Roll: a Jinbeh signature
                    </li>
                  </ul>
                </div>
              </div>
        ...
        <section className="py-16 bg-warm-ivory">
          <div className="container mx-auto px-6">
            ...
            <div className="flex flex-wrap justify-center gap-3 max-w-3xl mx-auto text-sm">
              ...
              <Link href="/menu" className="px-4 py-2 bg-white rounded-full text-charcoal hover:bg-accent-red hover:text-white transition-colors">Sashimi Deluxe</Link>
              <Link href="/menu" className="px-4 py-2 bg-white rounded-full text-charcoal hover:bg-accent-red hover:text-white transition-colors">Specialty Rolls</Link>
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-6">
            ...
            <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
              <Link href="/blog/romantic-anniversary-dinners" className="group block bg-warm-ivory rounded-xl p-6 hover:shadow-lg transition-shadow">
                <span className="text-sm text-accent-red font-medium uppercase tracking-wider">Fine Dining</span>
                <h3 className="font-heading text-lg font-semibold text-charcoal mt-2 group-hover:text-accent-red transition-colors">
                  Romantic Dinner Ideas in DFW
                </h3>
                <p className="text-sm text-charcoal/70 mt-2">Treat mom to an unforgettable fine dining experience she deserves.</p>
              </Link>
              <Link href="/blog/sake-pairing-guide" className="group block bg-warm-ivory rounded-xl p-6 hover:shadow-lg transition-shadow">
                ...
                <p className="text-sm text-charcoal/70 mt-2">Elevate her dinner with perfectly paired sake for every course.</p>
              </Link>
            </div>
          </div>
        </section>
