...
export const metadata: Metadata = {
  ...
  description: "Diced ahi tuna with avocado and ponzu Enjoy Tuna Tartare at Jinbeh Japanese Restaurant in Lewisville, TX. Easy access from I-35E, near Vista Ridge Mall. Call (214) 618-9798 to reserve.",
...
const faqSchema = {
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Check our happy hour specials! Many appetizers including items similar to Tuna Tartare are featured during our happy hour. Call (214) 618-9798 for current specials."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes, Tuna Tartare travels well for takeout. Call (214) 618-9798 directly or order online."
      }
    }
  ]
};
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg mb-8">
                ...
                <div className="space-y-6">
                  ...
                  <details className="group border-b border-warm-ivory pb-4">
                    ...
                    <p className="mt-4 text-charcoal/70 leading-relaxed">
                      Check our happy hour specials! Many appetizers including items similar to Tuna Tartare are featured during our happy hour. Call (214) 618-9798 for current specials.
                    </p>
                  </details>
                  <details className="group border-b border-warm-ivory pb-4">
                    <summary className="flex justify-between items-center cursor-pointer list-none">
                    ...
                    <p className="mt-4 text-charcoal/70 leading-relaxed">
                      Yes, Tuna Tartare travels well for takeout. Call (214) 618-9798 directly or order online.
                    </p>
                  </details>
                </div>
              </div>
