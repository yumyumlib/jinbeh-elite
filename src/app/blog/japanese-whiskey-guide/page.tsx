...
export const metadata: Metadata = {
    ...
    openGraph: {
        ...
        images: ["/images/drinks/MuleSummerSignatureCocktail.jpg"],
    },
};
    ...
    return (
        <main className="min-h-screen bg-warm-ivory">
            ...
            <section className="relative h-[50vh] min-h-[400px] flex items-end overflow-hidden">
                <Image src="/images/catalog/7-C060324-6447.jpg" alt="Japanese whiskey bottles showcasing premium spirits" fill className="object-cover" priority />
