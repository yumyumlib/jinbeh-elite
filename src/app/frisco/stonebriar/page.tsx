...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "sushi near stonebriar frisco",
    "restaurants near stonebriar centre",
    "teppanyaki near stonebriar",
    "japanese food stonebriar frisco",
    "best sushi near stonebriar mall",
    "hibachi frisco stonebriar",
  ],
  openGraph: {
    title: "Japanese Restaurant Near Stonebriar Mall | Jinbeh Frisco",
    description: "Fresh sushi & exciting hibachi just minutes from Stonebriar Centre in Frisco, TX.",
    url: "https://jinbeh.com/frisco/stonebriar",
    images: [
      {
        url: "https://jinbeh.com/images/photoshoot/sushi-tower.jpg",
        width: 1200,
        height: 630,
        alt: "Jinbeh Japanese Restaurant — Frisco Stonebriar",
      },
    ],
  },
  alternates: {
    canonical: "https://jinbeh.com/frisco/stonebriar",
  },
};
...
const faqSchema = {
  ...
  mainEntity: [
    {
      "@type": "Question",
      name: "How far is Jinbeh from Stonebriar Centre Mall?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Jinbeh Frisco is just 5 minutes (about 1.5 miles) from Stonebriar Centre Mall on Preston Road. It's the perfect spot for dinner before or after shopping!",
      },
    },
    {
      "@type": "Question",
      name: "Is there parking near Jinbeh Frisco?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Yes! Jinbeh Frisco has convenient free parking in the shopping center lot directly in front of our restaurant. Plenty of spaces available.",
      },
    },
    {
      "@type": "Question",
      name: "Do I need reservations for hibachi near Stonebriar?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "We highly recommend reservations for hibachi dining, especially on weekends and holidays. You can book online through OpenTable or call us at (214) 619-1200.",
      },
    },
    {
      "@type": "Question",
...
const nearbyAttractions = [
  {
    ...
    description: "Premier shopping destination with 165+ stores",
  },
  {
    name: "Toyota Stadium",
    distance: "8 min drive",
    description: "Home of FC Dallas and major events",
  },
  {
    name: "The Star in Frisco",
    distance: "10 min drive",
    description: "Dallas Cowboys headquarters and entertainment",
  },
  {
    name: "Dr Pepper Ballpark",
    distance: "7 min drive",
    description: "Home of the Frisco RoughRiders",
  },
];

export default function StonebriarPage() {
  return (
    <>
      <Header location="frisco" />
      <div className="container mx-auto max-w-6xl px-4 lg:px-6">
        <BreadcrumbNav items={[{ label: "Frisco", href: "/frisco" }, { label: "Stonebriar" }]} />
      </div>
        ...
        <section className="relative h-[50vh] min-h-[400px] flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 text-center text-white px-6 max-w-4xl mx-auto">
            <p className="text-soft-gold font-medium tracking-wider uppercase mb-4">
              Just 5 Minutes from Stonebriar Centre
            </p>
            <h1 className="text-4xl md:text-5xl font-heading font-bold mb-6">
              Japanese Restaurant Near Stonebriar Mall
            </h1>
            <p className="text-xl text-warm-ivory/90 max-w-2xl mx-auto mb-8">
              ...
              your perfect dining destination before or after shopping!
            </p>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div>
                  <h2 className="text-3xl md:text-4xl font-heading font-bold text-charcoal mb-6">
                    The Best Hibachi & Sushi Near Stonebriar
                  </h2>
          ...
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto text-center mb-12">
              ...
              <p className="text-lg text-charcoal/70">
                Jinbeh Frisco is perfectly positioned near all the action
              </p>
            </div>
        ...
        <section className="py-16 bg-gradient-to-br from-accent-red to-deep-indigo text-white">
          <div className="container mx-auto px-6 text-center">
            ...
            <p className="text-xl text-white/90 max-w-2xl mx-auto mb-10">
              Reserve your table at Jinbeh Frisco today. Just 5 minutes from Stonebriar Centre!
            </p>
