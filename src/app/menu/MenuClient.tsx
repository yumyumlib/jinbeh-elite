                                    ...
                                    <div className="space-y-3">
                                        {loc.menus.map((menu) => (
                                            <a
                                                ...
                                                aria-label="Link" className="flex items-center gap-3 px-4 py-3 rounded-xl bg-warm-ivory hover:bg-accent-red/5 border border-transparent hover:border-accent-red/20 transition-all group"
                                            >
