...
const faqSchema = {
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes! Most appetizers items are available for takeout and delivery. Call (214) 618-9888 or order online. "
      }
    },
    {
      "@type": "Question",
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg space-y-6">
                ...
                <details className="group border-b border-warm-ivory pb-4">
                  ...
                  <p className="mt-4 text-charcoal/70 leading-relaxed">
                    Yes! Most appetizers items are available for takeout and delivery. Call (214) 618-9888 or order online. 
                  </p>
                </details>
                <details className="group border-b border-warm-ivory pb-4">
                  <summary className="flex justify-between items-center cursor-pointer list-none">
