        ...
        <div className="container mx-auto max-w-6xl px-4 lg:px-6">
          <BreadcrumbNav items={[{ label: "Blog", href: "/blog" }, { label: "Popular Japanese Culture" }]} />
            ...
            <section className="relative h-[50vh] min-h-[400px] flex items-end overflow-hidden">
                <Image src="/images/photoshoot/hibachi-onion-volcano-flame.jpg" alt="Popular Japanese Culture at Jinbeh Japanese restaurant" fill className="object-cover" priority />
