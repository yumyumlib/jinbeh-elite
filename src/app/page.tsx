  ...
  return (
    <>
      ...
      <main id="main-content" className="min-h-screen -mt-14">
        ...
        <section className="py-24 bg-warm-ivory">
          <div className="container mx-auto px-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 lg:gap-5 max-w-6xl mx-auto">
              {/* Row 1 */}
              <ScrollReveal delay={0} className="gallery-item md:col-span-2 aspect-[16/10] rounded-2xl">
                <Image
              ...
              <ScrollReveal delay={300} className="gallery-item md:col-span-2 aspect-[16/10] rounded-2xl">
                <Image
        ...
        <section className="py-16 bg-warm-ivory overflow-hidden">
          ...
          <div className="relative">
            ...
            <Marquee pauseOnHover duration={120}>
              {[
                ...
                <div key={i} className="relative w-[240px] h-[240px] mx-2 rounded-xl overflow-hidden group flex-shrink-0">
                  <Image
                    src={img.src}
                    alt={img.alt}
                    fill
          ...
          <div className="container mx-auto px-6 text-center mt-8">
            <ScrollReveal>
              <a
                ...
                className="inline-flex items-center gap-2 bg-gradient-to-r from-deep-indigo via-accent-red to-soft-gold text-white px-8 py-3 rounded-full font-semibold hover:opacity-90 transition-opacity shadow-lg hover:shadow-xl hover:scale-105 transition-all"
              >
