...
export const metadata: Metadata = {
  ...
  description: "Celebrate Thanksgiving at Jinbeh! Let us cook while you relax. Hibachi, sushi, and Japanese dining in Frisco and Lewisville TX. Open Thanksgiving Day.",
  keywords: [
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Jinbeh Japanese Restaurant — Celebrations Thanksgiving",
      },
    ],
    type: "website",
  },
...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Absolutely! Thanksgiving is very popular for families who prefer to dine out. Call Frisco at (214) 619-1200 or Lewisville at (214) 488-2224 to reserve. We recommend booking 1-2 weeks in advance.",
      },
    },
    {
      "@type": "Question",
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Thanksgiving" },
  ],
};
          ...
          <div className="container mx-auto px-6 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="btn bg-accent-red text-white hover:bg-accent-red/90 px-6 py-3 rounded-xl font-semibold shadow-lg inline-block"
              >
